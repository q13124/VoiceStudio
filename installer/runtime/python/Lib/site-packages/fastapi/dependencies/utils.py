...
def is_union_of_base_models(field_type: Any) -> bool:
    ...
    return all(lenient_issubclass(arg, BaseModel) for arg in union_args)
...
def _should_embed_body_fields(fields: list[ModelField]) -> bool:
    ...
    return bool(isinstance(first_field.field_info, params.Form) and not lenient_issubclass(first_field.field_info.annotation, BaseModel) and not is_union_of_base_models(first_field.field_info.annotation))
