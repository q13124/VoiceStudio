...
def test_stdin_text():
    ...
    assert f"text: {textstdin}" in log
    assert result.exit_code == 0
...
def test_stdin_text_unicode():
    ...
    assert f"text: {textstdin_unicode}" in log
    assert result.exit_code == 0
...
def test_text_unicode():
    ...
    assert f"text: {text_unicode}" in log
    assert result.exit_code == 0
