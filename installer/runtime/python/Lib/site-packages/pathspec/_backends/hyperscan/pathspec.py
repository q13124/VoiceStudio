...
from typing import (
	Any,  # Replaced by `collections.abc.Callable` in 3.9.2.
	)
...
from pathspec._backends._utils import enumerate_patterns
...
class HyperscanPsBackend(_Backend):
	...
	def __init__(
		...
		*,
		_debug_exprs: bool | None = None,
		_test_sort: Callable[[list], None] | None = None,
	) -> None:
		"""
		...
		*patterns* (:class:`Sequence` of :class:`.RegexPattern`) contains the
		...
		self._db: hyperscan.Database | None = db
		"""
		...
		*_expr_data* (:class:`list`) maps expression index (:class:`int`) to
		...
		self._out: tuple[bool | None, int] = (None, -1)
		"""
	...
	def _init_db(
		...
		sort_ids: Callable[[list[int]], None] | None,
	...
	@override
	def match_file(self, file: str) -> tuple[bool | None, int | None]:
		"""
