...
class GitIgnoreSpec(PathSpec):
	...
	*gitignore* behavior. This is uses :class:`.GitIgnoreSpecPattern` to fully
	...
	def from_lines(
		cls: type[Self],
		pattern_factory: str | Callable[[AnyStr], Pattern] | None,
		lines: Iterable[AnyStr],
		*,
		backend: BackendNamesHint | str | None = None,
		_test_backend_factory: Callable[[Sequence[Pattern]], _Backend] | None = None,
	) -> Self:
		...
