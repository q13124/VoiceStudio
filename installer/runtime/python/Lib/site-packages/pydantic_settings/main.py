...
class BaseSettings(BaseModel):
    ...
    def _settings_build_values(
        ...
        cli_parse_none_str = env_parse_none_str if env_parse_none_str else cli_parse_none_str
        cli_hide_none_type = (
        ...
        sources = (*self.settings_customise_sources(self.__class__, init_settings=init_settings, env_settings=env_settings, dotenv_settings=dotenv_settings, file_secret_settings=file_secret_settings), default_settings)
