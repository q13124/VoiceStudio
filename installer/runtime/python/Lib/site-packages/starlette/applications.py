...
class Starlette:
    ...
    def build_middleware_stack(self) -> ASGIApp:
        ...
        middleware = (
            [Middleware(ServerErrorMiddleware, handler=error_handler, debug=debug), *self.user_middleware, Middleware(ExceptionMiddleware, handlers=exception_handlers, debug=debug)]
        )
