...
class ArgFormatter:
    ...
    def GetInterfaceArgCleanup(self):
        ...
        if DEBUG:
            return f"/* GetInterfaceArgCleanup output goes here: {self.arg.name} */\n"
        else:
            return ""
    ...
    def GetInterfaceArgCleanupGIL(self):
        ...
        if DEBUG:
            return (
                f"/* GetInterfaceArgCleanup (GIL held) output goes here: {self.arg.name} */\n"
            )
        else:
            return ""
    ...
    def DeclareParseArgTupleInputConverter(self):
        ...
        if DEBUG:
            return (
                f"/* Declare ParseArgTupleInputConverter goes here: {self.arg.name} */\n"
            )
        else:
            return ""
    ...
    def GetParsePostCode(self):
        ...
        if DEBUG:
            return f"/* GetParsePostCode code goes here: {self.arg.name} */\n"
        else:
            return ""
    ...
    def GetBuildForInterfacePreCode(self):
        ...
        if DEBUG:
            return f"/* GetBuildForInterfacePreCode goes here: {self.arg.name} */\n"
        else:
            return ""
    ...
    def GetBuildForGatewayPreCode(self):
        ...
        if DEBUG and s[:4] == "/* G":
            s = f"/* GetBuildForGatewayPreCode goes here: {self.arg.name} */\n"
        return s
    ...
    def GetBuildForInterfacePostCode(self):
        ...
        if DEBUG:
            return f"/* GetBuildForInterfacePostCode goes here: {self.arg.name} */\n"
        return ""
    ...
    def GetBuildForGatewayPostCode(self):
        ...
        if DEBUG and s[:4] == "/* G":
            s = f"/* GetBuildForGatewayPostCode goes here: {self.arg.name} */\n"
        return s
...
class ArgFormatterFloat(ArgFormatter):
    ...
    def DeclareParseArgTupleInputConverter(self):
        ...
        return f"\tdouble dbl{self.arg.name};\n"
...
class ArgFormatterLONG_PTR(ArgFormatter):
    ...
    def DeclareParseArgTupleInputConverter(self):
        ...
        return f"\tPyObject *ob{self.arg.name};\n"
    ...
    def GetBuildForInterfacePostCode(self):
        return f"\tPy_XDECREF(ob{self.arg.name});\n"
...
class ArgFormatterOLECHAR(ArgFormatterPythonCOM):
    ...
    def GetInterfaceArgCleanup(self):
        return f"\tSysFreeString({self.GetIndirectedArgName(None, 1)});\n"
...
class ArgFormatterTCHAR(ArgFormatterPythonCOM):
    ...
    def GetInterfaceArgCleanup(self):
        return f"\tPyWinObject_FreeTCHAR({self.GetIndirectedArgName(None, 1)});\n"
...
class ArgFormatterIID(ArgFormatterPythonCOM):
    ...
    def GetInterfaceCppObjectInfo(self):
        return self.arg.name, f"IID {self.arg.name}"
...
class ArgFormatterTime(ArgFormatterPythonCOM):
    ...
    def GetBuildForInterfacePostCode(self):
        ...
        if self.builtinIndirection + self.arg.indirectionLevel > 1:
            # memory returned into an OLECHAR should be freed
            ret = f"\tCoTaskMemFree({self.arg.name});\n"
    ...
    def BuildFromFile(self, file):
        ...
        if self.result != "HRESULT":
            if self.result == "DWORD":  # DWORD is for old old stuff?
                ...
                print(
                    f"Method {self.name} - Only HRESULT return types are supported."
                )
