...
unittest_modules = [
    ...
    ["testIterators", "testvbscript_regexp", "testStorage", "testStreams", "testWMI", "policySemantics", "testShell", "testROT", "testxslt", "testCollections", "errorSemantics.test", "testArrays", "testClipboard", "testConversionErrors"],
    ...
    ["testMSOffice.TestAll", "testMSOfficeEvents.test", "testAccess.test", "testExplorer.TestAll", "testExchange.test"],
    ...
    for i in range(testLevel):
        for mod_name in unittest_modules[i]:
            ...
            if func is not None:
                ...
                test = mod.suite() if hasattr(mod, "suite") else loader.loadTestsFromModule(mod)
