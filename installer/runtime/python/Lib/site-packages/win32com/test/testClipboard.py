...
IDataObject_Methods = ["GetData", "GetDataHere", "QueryGetData", "GetCanonicalFormatEtc", "SetData", "EnumFormatEtc", "DAdvise", "DUnadvise", "EnumDAdvise"]
...
class TestDataObject:
    ...
    def QueryGetData(self, fe):
        _cf, _target, aspect, _index, tymed = fe
