...
def Moniker(Pathname, clsctx=pythoncom.CLSCTX_ALL):
    ...
    """
    moniker, _i, bindCtx = pythoncom.MkParseDisplayName(Pathname)
...
def DispatchEx(
    ...
    serverInfo = None if machine is None else (machine,)
    if userName is None:
        userName = clsid
...
def WithEvents(disp, user_event_class):
    ...
    """
    disp, _disp_class, events_class = __get_disp_and_event_classes(disp)
    result_class = type(
        "COMEventClass",
