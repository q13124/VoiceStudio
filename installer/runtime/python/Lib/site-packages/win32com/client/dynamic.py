...
class CDispatch:
    ...
    def _make_method_(self, name):
        ...
        try:
            ...
            codeObject = compile(methodCode, f"<COMObject {self._username_}>", "exec")
    ...
    def __getattr__(self, attr):
        ...
        if retEntry is not None:  # see if in my cache
            try:
                ...
                debug_attr_print(f"Attribute {attr} not in cache")
        ...
        if retEntry is not None:
            ...
            debug_attr_print(
                f"Getting property Id 0x{retEntry.dispid:x} from OLE object"
            )
            try:
