...
class DescriptorPool:
      ...
      try:
        ...
        if isinstance(all_numbers, list):
          ...
          warnings.warn(
              ...
              f' not {type(all_numbers)}', stacklevel=2
          )
  ...
  def SetFeatureSetDefaults(self, defaults):
    ...
    if defaults.minimum_edition > defaults.maximum_edition:
      raise ValueError(
          f'Invalid edition range {descriptor_pb2.Edition.Name(defaults.minimum_edition)} to {descriptor_pb2.Edition.Name(defaults.maximum_edition)}'
      )
    ...
    for d in defaults.defaults:
      ...
      if prev_edition >= d.edition:
        raise ValueError(
            f'Feature set defaults are not strictly increasing.  {descriptor_pb2.Edition.Name(prev_edition)} is greater'
            f' than or equal to {descriptor_pb2.Edition.Name(d.edition)}'
        )
  ...
  def _CreateDefaultFeatures(self, edition):
    ...
    if edition < self._edition_defaults.minimum_edition:
      raise TypeError(
          'Edition {} is earlier than the minimum supported edition {}!'.format(
    ...
    if (
      ...
      raise TypeError(
          'Edition {} is later than the maximum supported edition {}!'.format(
              descriptor_pb2.Edition.Name(edition),
              descriptor_pb2.Edition.Name(
    ...
    if found is None:
      raise TypeError(
          f'No valid default found for edition {descriptor_pb2.Edition.Name(edition)}!'
      )
  ...
  def _ConvertFileProtoToFileDescriptor(self, file_proto):
    ...
    if file_proto.name not in self._file_descriptors:
      ...
      desc_proto_prefix = _PrefixWithDot(file_proto.package) if file_proto.package else ''
  ...
  def _ConvertMessageDescriptor(self, desc_proto, package=None, file_desc=None,
    ...
    desc_name = '.'.join((package, desc_proto.name)) if package else desc_proto.name
  ...
  def _ConvertEnumDescriptor(self, enum_proto, package=None, file_desc=None,
    ...
    enum_name = '.'.join((package, enum_proto.name)) if package else enum_proto.name
  ...
  def _MakeFieldDescriptor(self, field_proto, message_name, index,
    ...
    full_name = '.'.join((message_name, field_proto.name)) if message_name else field_proto.name
  ...
  def _SetAllFieldTypes(self, package, desc_proto, scope):
    ...
    for field_proto, field_desc in zip(desc_proto.field, main_desc.fields, strict=False):
      self._SetFieldType(field_proto, field_desc, nested_package, scope)

    for extension_proto, extension_desc in (
        zip(desc_proto.extension, main_desc.extensions, strict=False)):
      extension_desc.containing_type = self._GetTypeFromScope(
  ...
  def _SetFieldType(self, field_proto, field_desc, package, scope):
    ...
    if field_proto.label == descriptor.FieldDescriptor.LABEL_REPEATED:
      ...
      elif field_proto.type == descriptor.FieldDescriptor.TYPE_MESSAGE or field_proto.type == descriptor.FieldDescriptor.TYPE_GROUP:
        field_desc.default_value = None
      else:
        # All other types are of the "int" type.
  ...
  def _MakeServiceDescriptor(self, service_proto, service_index, scope,
    ...
    service_name = '.'.join((package, service_proto.name)) if package else service_proto.name
