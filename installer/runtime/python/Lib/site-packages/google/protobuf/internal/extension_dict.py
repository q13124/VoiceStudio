...
def _VerifyExtensionHandle(message, extension_handle):
  ...
  if not isinstance(extension_handle, FieldDescriptor):
    raise KeyError(f'HasExtension() expects an extension handle, got: {extension_handle}')
  ...
  if extension_handle.containing_type is not message.DESCRIPTOR:
    raise KeyError(f'Extension "{extension_handle.full_name}" extends message type "{extension_handle.containing_type.full_name}", but this '
                   f'message is of type "{message.DESCRIPTOR.full_name}".')
...
class _ExtensionDict:
  ...
  def __setitem__(self, extension_handle, value):
    ...
    if (extension_handle.is_repeated or
      ...
      raise TypeError(
          f'Cannot assign to extension "{extension_handle.full_name}" because it is a repeated or '
          'composite type.')
