  ...
  def __init__(cls, name, bases, dictionary):
    ...
    if existing_class:
      assert existing_class is cls, (
          f'Duplicate `GeneratedProtocolMessageType` created for descriptor {descriptor.full_name!r}')
      return
...
def _DefaultValueConstructorForField(field):
  ...
  if field.is_repeated:
    if field.has_default_value and field.default_value != []:
      raise ValueError(f'Repeated field default value not empty list: {field.default_value}')
...
def _ReraiseTypeErrorWithFieldName(message_name, field_name):
  ...
  if len(exc.args) == 1 and type(exc) is TypeError:
    ...
    exc = TypeError(f'{exc!s} for field {message_name}.{field_name}')
  ...
  def init(self, **kwargs):
    ...
    def init_wkt_or_merge(field, msg, value):
      if isinstance(value, message_mod.Message):
        ...
        raise TypeError(
            f'Message field {message_descriptor.name}.{field.name} must be initialized with a '
            f'dict or instance of same class, got {type(value).__name__}.'
        )
    ...
    for field_name, field_value in kwargs.items():
      ...
      if field is None:
        raise TypeError(f'{message_descriptor.name}() got an unexpected keyword argument "{field_name}"')
...
def _GetFieldByName(message_descriptor, field_name):
  ...
  try:
    ...
    raise ValueError(f'Protocol message {message_descriptor.name} has no "{field_name}" field.')
...
def _AddPropertiesForRepeatedField(field, cls):
  ...
  def setter(self, new_value):
    raise AttributeError('Assignment not allowed to repeated field '
                         f'"{proto_field_name}" in protocol message object.')
...
def _AddHasFieldMethod(message_descriptor, cls):
  ...
  def HasField(self, field_name):
    try:
      ...
      raise ValueError(f'Protocol message {message_descriptor.full_name} has no non-repeated field "{field_name}" '
                       'nor has presence is not available for this field.') from exc
...
def _AddHasExtensionMethod(cls):
  ...
  def HasExtension(self, field_descriptor):
    ...
    if field_descriptor.is_repeated:
      raise KeyError(f'"{field_descriptor.full_name}" is repeated.')
  ...
  def InternalParse(self, buffer, pos, end, current_depth=0):
    ...
    while pos != end:
      ...
      if field_des is None:
        ...
        (_data, new_pos) = decoder._DecodeUnknownField(
  ...
  def MergeFrom(self, msg):
    if not isinstance(msg, cls):
      raise TypeError(
          ...
          f'expected {_FullyQualifiedClassName(cls)} got {_FullyQualifiedClassName(msg.__class__)}.')
...
def _AddWhichOneofMethod(message_descriptor, cls):
  def WhichOneof(self, oneof_name):
    ...
    try:
      ...
      raise ValueError(
          f'Protocol message has no oneof "{oneof_name}" field.')
