...
class Error:
    ...
    def get_description(self, concise: bool = False) -> str:
        ...
        if not isinstance(self.runtime_object, Missing):
            with suppress(OSError, TypeError, SyntaxError):
    ...
    if (
        ...
        if isinstance(runtime, enum.Enum):
            ...
            if (
                ...
                if value_t is None or value_t.type is None or runtime_type is None or is_subtype_helper(runtime_type, value_t.type):
                    should_error = False
                else:
