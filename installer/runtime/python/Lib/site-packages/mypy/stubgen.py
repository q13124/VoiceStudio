...
class ASTStubGenerator(BaseStubGenerator, mypy.traverser.TraverserVisitor):
    ...
    def visit_func_def(self, o: FuncDef) -> None:
        ...
        if self._class_stack:
            self_var = o.arguments[0].variable.name if len(o.arguments) else "self"
    ...
    def is_alias_expression(self, expr: Expression, top_level: bool = True) -> bool:
        ...
        if isinstance(expr, CallExpr) and self.get_fullname(expr.callee) in TYPE_VAR_LIKE_NAMES:
            ...
            indices = expr.index.items if isinstance(expr.index, TupleExpr) else [expr.index]
...
def is_non_library_module(module: str) -> bool:
    ...
    if module.split(".")[-1].startswith("test_"):
        return True
    return bool(".tests." in module or ".test." in module or ".testing." in module or ".SelfTest." in module)
