...
class NodeFixer(NodeVisitor[None]):
            ...
            if cross_ref is not None:  # Fix up cross-reference.
                ...
                if cross_ref in self.modules:
                    ...
                    if stnode is not None:
                        ...
                        raise AssertionError(f"Could not find cross-ref {cross_ref}")
                    else:
                ...
                if isinstance(value.node, TypeInfo):
                    ...
                    raise AssertionError(f"Unexpected empty node {key!r}: {value}")
    ...
    def visit_overloaded_func_def(self, o: OverloadedFuncDef) -> None:
        ...
        if isinstance(o.type, Overloaded):
            ...
            for typ, item in zip(o.type.items, o.items, strict=False):
                typ.definition = item
