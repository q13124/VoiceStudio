...
class TypeVarLikeScope:
    ...
    def allow_binding(self, fullname: str) -> bool:
        return not (fullname in self.scope or (self.parent and not self.parent.allow_binding(fullname)) or (self.prohibited and not self.prohibited.allow_binding(fullname)))
