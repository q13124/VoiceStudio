...
class ConstraintBuilderVisitor(TypeVisitor[list[Constraint]]):
    ...
    def visit_type_var(self, template: TypeVarType) -> list[Constraint]:
        raise AssertionError("Unexpected TypeVarType in ConstraintBuilderVisitor" " (should have been handled in infer_constraints)")
    ...
    def visit_typeddict_type(self, template: TypedDictType) -> list[Constraint]:
        ...
        if isinstance(actual, TypedDictType):
            ...
            for _item_name, template_item_type, actual_item_type in template.zip(actual):
    ...
    def visit_union_type(self, template: UnionType) -> list[Constraint]:
        raise AssertionError("Unexpected UnionType in ConstraintBuilderVisitor" " (should have been handled in infer_constraints)")
    ...
    if isinstance(tp, TupleType):
        for base in tp.partial_fallback.type.mro:
            if base.fullname == "builtins.tuple":
                return base
    raise AssertionError("Invalid unpack type")
