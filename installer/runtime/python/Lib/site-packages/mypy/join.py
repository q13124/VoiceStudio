...
class TypeJoinVisitor(TypeVisitor[ProperType]):
    ...
    def visit_instance(self, t: Instance) -> ProperType:
        ...
        elif isinstance(self.s, (TypeType, TypedDictType, TupleType, LiteralType)):
    ...
    def default(self, typ: Type) -> ProperType:
        ...
        elif isinstance(typ, (TypedDictType, FunctionLike)):
            return self.default(typ.fallback)
        elif isinstance(typ, (TypeVarType, ParamSpecType)):
...
def join_similar_callables(t: CallableType, s: CallableType) -> CallableType:
    ...
    fallback = t.fallback if t.fallback.type.fullname == "builtins.function" else s.fallback
    return t.copy_modified(
        arg_types=arg_types,
