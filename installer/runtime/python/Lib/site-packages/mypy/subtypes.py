...
class SubtypeVisitor(TypeVisitor[bool]):
        ...
        if isinstance(right, TupleType):
            ...
            if left.type.has_base(right.partial_fallback.type.fullname):
                if not self.proper_subtype:
                    ...
                    if is_erased_instance(mapped) and (
    ...
    def visit_unpack_type(self, left: UnpackType) -> bool:
        ...
        return bool(isinstance(self.right, Instance) and self.right.type.fullname == "builtins.object")
    ...
    def visit_overloaded(self, left: Overloaded) -> bool:
        ...
        if isinstance(right, Instance):
            ...
            return any(self._is_subtype(item, right) for item in left.items)
        elif isinstance(right, Overloaded):
            if left == self.right:
    ...
    def visit_type_type(self, left: TypeType) -> bool:
        ...
        if left.is_type_form:
            ...
            if isinstance(right, Instance):
                return right.type.fullname == "builtins.object"
            return False
