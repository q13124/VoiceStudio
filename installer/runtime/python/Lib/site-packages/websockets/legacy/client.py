...
__all__ = ["WebSocketClientProtocol", "connect", "unix_connect"]
...
class WebSocketClientProtocol(WebSocketCommonProtocol):
    ...
    def process_subprotocol(
        ...
        if header_values:
            ...
            parsed_header_values: Sequence[Subprotocol] = functools.reduce(operator.iadd, [parse_subprotocol(header_value) for header_value in header_values], [])
