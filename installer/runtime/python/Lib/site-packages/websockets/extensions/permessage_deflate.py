...
from websockets.typing import BytesLike, ExtensionName, ExtensionParameter
...
class PerMessageDeflate(Extension):
    ...
    def encode(self, frame: frames.Frame) -> frames.Frame:
        ...
        if frame.fin:
            ...
            data = data[:-4] if len(data) < 2048 else memoryview(data)[:-4]
...
class ServerPerMessageDeflateFactory(ServerExtensionFactory):
    ...
    def process_request_params(
        ...
        if self.server_max_window_bits is None:
            ...
            if server_max_window_bits is None or server_max_window_bits > self.server_max_window_bits:
        ...
        if self.client_max_window_bits is None:
            ...
            elif client_max_window_bits is True or self.client_max_window_bits < client_max_window_bits:
                client_max_window_bits = self.client_max_window_bits
