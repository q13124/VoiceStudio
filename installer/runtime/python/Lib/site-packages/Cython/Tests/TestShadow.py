...
class TestShadow(unittest.TestCase):
    def test_all_directives_in_shadow(self):
        missing_directives = []
        extra_directives = []
        for full_directive in Options.directive_types:
    ...
    def test_all_types_in_shadow(self):
        ...
        missing_types = []
        for key in cython_scope.entries:
    ...
    def test_most_types(self):
        ...
        missing_types = []
        missing_lookups = []
        for (_signed, _longness, name), type_ in PyrexTypes.modifiers_and_name_to_type.items():
            if name == 'object':
