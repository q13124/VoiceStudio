...
class FusedCFuncDefNode(StatListNode):
    ...
    def copy_def(self, env):
        ...
        for cname, fused_to_specific in permutations:
            ...
            specialised_type_names = [
                ...
                for (farg, sarg) in zip(self.node.args, copied_node.args, strict=False)
    ...
    def replace_fused_typechecks(self, copied_node):
        ...
        return not Errors.get_errors_count() > num_errors
    ...
    def _buffer_declarations(self, pyx_code, decl_code, all_buffer_types, pythran_types):
        ...
        for buffer_type in all_buffer_types:
            ...
            elif dtype.is_typedef and dtype_name not in seen_typedefs:
            ...
            if dtype.is_int and str(dtype) not in seen_int_dtypes:
    ...
    def make_fused_cpdef(self, orig_py_func, env, is_def):
        ...
        for i, arg in enumerate(self.node.args):
            ...
            if arg.type.is_fused and fused_type not in seen_fused_types:
                ...
                mapper_sig = ', '.join(f"{atype} {aname}" for atype, aname in zip(mapper_arg_types, mapper_arg_names, strict=False))
    ...
    def analyse_expressions(self, env):
        ...
        for i, stat in enumerate(self.stats):
            ...
            if isinstance(stat, FuncDefNode) and stat is not self.py_func:
                ...
                for arg, default in zip(stat.args, defaults, strict=False):
    ...
    def generate_function_definitions(self, env, code):
        ...
        for stat in self.stats:
            if isinstance(stat, FuncDefNode) and (
                    stat.entry.used or
                    (Options.cimport_from_pyx and stat.entry.visibility != 'extern')):
