...
from .Code import KNOWN_PYTHON_BUILTINS, TempitaUtilityCode, UtilityCode, uncachable_builtins
...
def init_builtin_types():
    ...
    for name, cname, methods in builtin_types_table:
        if name == 'frozenset':
            ...
            objstruct_cname = 'PyLongObject'
        elif name == 'BaseException' or name == 'Exception':
