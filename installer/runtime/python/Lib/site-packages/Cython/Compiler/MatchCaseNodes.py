...
class MatchMappingPatternNode(PatternNode):
    ...
    child_attrs = [*PatternNode.child_attrs, "keys", "value_patterns", "double_star_capture_target"]
...
class ClassPatternNode(PatternNode):
    ...
    child_attrs = [*PatternNode.child_attrs, "class_", "positional_patterns", "keyword_pattern_names", "keyword_pattern_patterns"]
