...
class AnnotationCCodeWriter(CCodeWriter):
    ...
    def _save_annotation_header(self, c_file, source_filename, coverage_timestamp=None):
        ...
        if c_file:
            outlist.append(f'<p>Raw output: <a href="{c_file}">{c_file}</a></p>\n')
        return outlist
    ...
    def _save_annotation_body(self, cython_code, generated_code, annotation_items, scopes, covered_lines=None):
        ...
        new_calls_map = dict.fromkeys(['refnanny', 'trace', 'py_macro_api', 'py_c_api', 'pyx_macro_api', 'pyx_c_api', 'error_goto'], 0).copy
...
class AnnotationItem:
    ...
    def start(self):
        return f"<span class='cython tag {self.style}' title='{self.text}'>{self.tag}"
