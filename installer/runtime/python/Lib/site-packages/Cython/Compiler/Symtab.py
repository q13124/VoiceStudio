...
from Cython.Utils import try_finally_contextmanager
...
class Scope:
    ...
    def declare_var(self, name, type, pos,
        ...
        if not cname:
            cname = name if visibility != 'private' or api else self.mangle(Naming.var_prefix, name)
    ...
    def declare_cfunction(self, name, type, pos,
        ...
        if entry:
            ...
            if visibility != 'private' and visibility != entry.visibility:
                warning(pos, f"Function '{name}' previously declared as '{entry.visibility}', now as '{visibility}'", 1)
    ...
    def find_imported_module(self, path, pos):
        ...
        for name in path:
            ...
            if entry.as_module:
                ...
                error(pos, "'{}' is not a cimported module".format('.'.join(path)))
                return None
        return scope
    ...
    def _emit_class_private_warning(self, pos, name):
        warning(pos, f"Global name {name} matched from within class scope "
                            "in contradiction to Python 'class private name' rules. "
                            "This may change in a future release.", 1)
...
class ModuleScope(Scope):
    ...
    def allocate_vtable_names(self, entry):
        ...
        if type.base_type and type.base_type.vtabslot_cname:
            ...
            type.vtabslot_cname = f"{Naming.obj_base_cname}.{type.base_type.vtabslot_cname}"
...
class CClassScope(ClassScope):
    ...
    def lookup_here(self, name):
        ...
        if entry and entry.is_builtin_cmethod and not self.parent_type.is_builtin_type:
