...
class EmbedSignature(CythonTransform):
    ...
    def _fmt_arg(self, arg):
        ...
        elif self.is_format_python and not arg.annotation:
            annotation = self._fmt_type(arg.type)
        if arg.annotation and not self.is_format_clinic:
