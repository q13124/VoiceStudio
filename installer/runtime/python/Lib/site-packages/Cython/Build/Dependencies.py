...
from Cython.Compiler.Options import CompilationOptions, default_options, get_directive_defaults
...
def _legacy_strtobool(val):
    ...
    import warnings
    warnings.warn("The 'np_python' option requires 'True' or 'False'", stacklevel=2, category=DeprecationWarning)
    val = val.lower()
        ...
        if source is not None:
            ...
            for line in source_lines:
                ...
                if kind is not None:
                    ...
                    type = distutils_settings.get(key)
...
class DependencyTree:
    ...
    def cimports_externs_incdirs(self, filename):
        ...
        cimports, _includes, externs = self.parse_dependencies(filename)[:3]
    ...
    def distutils_info0(self, filename):
        ...
        kwds = info.values
        _cimports, externs, incdirs = self.cimports_externs_incdirs(filename)
        basedir = os.getcwd()
...
def default_create_extension(template, kwds):
    ...
    metadata = {'distutils': kwds, 'module_name': kwds['name']}
    return (ext, metadata)
...
def create_extension_list(patterns, exclude=None, ctx=None, aliases=None, quiet=False, language=None,
    ...
    for pattern in patterns:
        if isinstance(pattern, str):
            ...
            msg = str(f"pattern is not of type str nor subclass of Extension ({Extension!r})"
    ...
    def record_results(func):
        def with_record(*args):
            ...
            try:
                ...
                failures = 1 - success
                failure_item = "" if success else "failure"
...
def cythonize_one(pyx_file, c_file,
    ...
    from Cython.Compiler.Main import compile_single, default_options
