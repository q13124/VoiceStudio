...
from Cython.Utils import captured_fd, print_captured
...
class CythonMagics(Magics):
    ...
    def cython(self, line, cell):
        ...
        try:
            with captured_fd(1) as get_stdout, captured_fd(2) as get_stderr:
    ...
    def _add_pgo_flags(self, build_extension, step_name, temp_dir):
        ...
        if compiler_type == 'unix':
            ...
            if not compiler_cmd:
                ...
                compiler_type = 'icc'
            elif 'gcc' in compiler_cmd or 'gcc' in compiler_cmd[0] or 'g++' in compiler_cmd or 'g++' in compiler_cmd[0]:
                compiler_type = 'gcc'
