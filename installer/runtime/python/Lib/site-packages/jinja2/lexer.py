...
class Lexer:
    ...
    def __init__(self, environment: "Environment") -> None:
        ...
        self.rules: dict[str, list[_Rule]] = {
            ...
            # blocks
            TOKEN_BLOCK_BEGIN: [_Rule(c(rf"(?:\+{block_end_re}|\-{block_end_re}\s*" rf"|{block_end_re}{block_suffix_re})"), TOKEN_BLOCK_END, "#pop"), *tag_rules],
            # variables
            TOKEN_VARIABLE_BEGIN: [_Rule(c(rf"\-{variable_end_re}\s*|{variable_end_re}"), TOKEN_VARIABLE_END, "#pop"), *tag_rules],
            # raw block
            TOKEN_RAW_BEGIN: [
                _Rule(
                    c(
