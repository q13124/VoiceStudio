...
class TestMetadata:
    ...
    def test_file_sandboxed(self, tmpdir):
        ...
        with get_dist(project, parse=False) as dist, pytest.raises(DistutilsOptionError):
    ...
    def test_interpolation(self, tmpdir):
        ...
        with pytest.raises(configparser.InterpolationMissingOptionError), get_dist(tmpdir):
            pass
...
class TestOptions:
    ...
    def test_warn_accidental_env_marker_misconfig(self, config, tmpdir):
        ...
        with pytest.warns(SetuptoolsDeprecationWarning, match=match), get_dist(tmpdir) as _:
            pass
    ...
    def test_python_requires_invalid(self, tmpdir):
        ...
        with pytest.raises(Exception), get_dist(tmpdir) as dist:
            dist.parse_config_files()
