...
from setuptools import Command, __version__, _shutil
from setuptools._core_metadata import _safe_license_file
...
class bdist_wheel(Command):
    ...
    def get_tag(self) -> tuple[str, str, str]:
        ...
        if self.root_is_pure:
            impl = "py2.py3" if self.universal else self.python_tag
    ...
    def license_paths(self) -> Iterable[str]:
        ...
        if setuptools_major_version >= 42:
            ...
            patterns = metadata["license_files"][1].split() if "license_files" in metadata else ()
