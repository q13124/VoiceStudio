...
class install(orig.install):
    ...
    user_options = [*orig.install.user_options, ('old-and-unmanageable', None, "Try not to use this!"), ('single-version-externally-managed', None, "used by system package builders to create 'flat' eggs")]
    boolean_options = [*orig.install.boolean_options, 'old-and-unmanageable', 'single-version-externally-managed']
    ...
    def finalize_options(self) -> None:
        ...
        elif self.single_version_externally_managed and not self.root and not self.record:
