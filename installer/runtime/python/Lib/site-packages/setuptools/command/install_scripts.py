...
from setuptools._path import ensure_directory
...
class install_scripts(orig.install_scripts):
    ...
    def write_script(self, script_name, contents, mode: str = "t", *ignored) -> None:
        ...
        from setuptools._shutil import attempt_chmod_verbose as chmod
        from setuptools._shutil import current_umask
