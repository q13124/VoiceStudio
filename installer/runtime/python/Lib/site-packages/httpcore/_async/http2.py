...
from httpcore._exceptions import ConnectionNotAvailable, LocalProtocolError, RemoteProtocolError
from httpcore._models import Origin, Request, Response
from httpcore._synchronization import AsyncLock, AsyncSemaphore, AsyncShieldCancellation
...
class AsyncHTTP2Connection(AsyncConnectionInterface):
    ...
    async def _send_request_headers(self, request: Request, stream_id: int) -> None:
        ...
        authority = next(v for k, v in request.headers if k.lower() == b"host")
