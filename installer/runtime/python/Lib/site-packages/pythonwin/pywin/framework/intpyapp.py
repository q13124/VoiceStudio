...
class InteractivePythonApp(app.CApp):
    ...
    def ProcessArgs(self, args, dde=None):
        ...
        while i < len(args):
            ...
            if argType in ("/nodde", "/new", "-nodde", "-new"):
                ...
                raise ValueError(f"Command line argument not recognised: {argType}")
    ...
    def DoLoadModules(self, moduleNames):  # ", sep string of module names.
        ...
        for module in modules:
            try:
                ...
                traceback.print_exc()
                msg = f'Startup import of user module "{module}" failed'
                print(msg)
    ...
    def OnFileLocate(self, id, code):
        ...
        if newName is None:
            win32ui.MessageBox(f"The file '{lastLocateFileName}' can not be located")
        else:
