...
class WindowOutputDocument(WindowOutputDocumentParent):
    ...
    def OnSaveDocument(self, fileName):
        ...
        try:
            ...
            win32ui.MessageBox(f"Error - could not save file\r\n\r\n{details}")
            return 0
        ...
        if line[:11] == "com_error: ":
            ...
            try:
                ...
                win32ui.SetStatusText(
                    f"The help file could not be opened - {details.strerror}"
                )
                return 1
            except:
                win32ui.SetStatusText(
        ...
        if matchResult is not None:
            ...
            if fileName[0] == "<":
                ...
                if fileName is None:
                    ...
                    win32ui.SetStatusText(
                        f"Can't locate the file '{fileNameSpec}'", 0
                    )
                    return 1
                ...
                if not scriptutils.JumpToDocument(fileName, int(lineNoString)):
                    win32ui.SetStatusText(f"Could not open {fileName}")
                    return 1  # still was an error message.
                return 1
...
class WindowOutputViewScintilla(
    ...
    def SetWordWrap(self, bWrapOn=1):
        wrap_mode = scintillacon.SC_WRAP_WORD if bWrapOn else scintillacon.SC_WRAP_NONE
