    ...
    def OnOpenDocument(self, filename):
        ...
        try:
            try:
                ...
                win32ui.MessageBox(f"Could not load the bitmap from {filename}")
                return 0
        finally:
            f.close()
...
class BitmapFrame(window.MDIChildWnd):
    def OnCreateClient(self, createparams, context):
        ...
        win32api.GetSystemMetrics(win32con.SM_CYCAPTION)  # includes border
        ...
        _left, _top, _right, _bottom = mdiClient.ScreenToClient(self.GetWindowRect())
