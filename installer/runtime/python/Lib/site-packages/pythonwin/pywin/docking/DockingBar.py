...
class DockingBar(window.Wnd):
    ...
    def CreateWindow(
        ...
        assert self.dialog.IsWindow(), (
            f"The childCreator function {childCreator} did not create a window!"
        )
    ...
    def OnWindowPosChanged(self, msg):
        ...
        _hwnd, _hwndAfter, _x, _y, _cx, _cy, flags = struct.unpack(format, bytes)
