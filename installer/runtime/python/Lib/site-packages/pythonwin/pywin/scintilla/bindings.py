    ...
    def fire(self, event, event_param=None):
        ...
        if binding is None:
            ...
            if handler is None:
                ...
                self.report_error(f"The event name '{event}' can not be found.")
        ...
        if handler_args_type == HANDLER_ARGS_GUESS:
            ...
            handler_args_type = HANDLER_ARGS_IDLE if event[0] == "<" else HANDLER_ARGS_EXTENSION
        try:
            ...
            if handler_args_type == HANDLER_ARGS_IDLE:
                ...
                rc = 0 if rc in (None, "break") else 1
        except:
            message = f"Firing event '{event}' failed."
            print(message)
            traceback.print_exc()
