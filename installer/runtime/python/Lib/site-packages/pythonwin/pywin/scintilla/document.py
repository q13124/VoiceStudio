...
class CScintillaDocument(ParentScintillaDocument):
    ...
    def OnOpenDocument(self, filename):
        ...
        try:
            ...
            rc = win32ui.MessageBox(
                f"Could not load the file from {filename}\n\nDo you want to create a new file?",
                "Pythonwin",
            ...
            try:
                ...
                rc = win32ui.MessageBox(f"Cannot create the file {filename}")
        return 1
    ...
    def _LoadTextFromFile(self, f):
        ...
        try:
            ...
            print(
                f"WARNING: Failed to decode bytes from '{source_encoding}' encoding - treating as latin1"
            )
            dec = text.decode("latin1")
        except LookupError:
            print(
                f"WARNING: Invalid encoding '{source_encoding}' specified - treating as latin1"
            )
            dec = text.decode("latin1")
