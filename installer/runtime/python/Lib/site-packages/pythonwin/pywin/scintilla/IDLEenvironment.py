...
def TkIndexToOffset(bm, edit, marks):
    ...
    if base.find(".") > 0:
        try:
            ...
            if col == "first" or col == "last":
                ...
                if sel[0] == sel[1]:
                    raise EmptyRange
                pos = sel[0] if col == "first" else sel[1]
            else:
            ...
            raise ValueError(f"Unexpected literal in '{base}'")
    elif base == "insert":
        pos = edit.GetSel()[0]
    elif base == "end":
        pos = edit.GetTextLength()
        ...
        try:
            ...
            raise ValueError(f"Unsupported base offset or undefined mark '{base}'")
    ...
    while 1:
        ...
        if word in ("+", "-"):
            ...
            raise ValueError(f"Unsupported relative offset '{word}'")
...
class TkText:
    ...
    def get(self, start, end=None):
        try:
            ...
            end = start + 1 if end is None else self._getoffset(end)
        except EmptyRange:
            return ""
    ...
    def mark_set(self, name, pos):
        try:
            ...
            raise TextError(f"Empty range '{pos}'")
        if name == "insert":
