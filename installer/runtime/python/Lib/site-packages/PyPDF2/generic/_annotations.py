...
class AnnotationBuilder:
    ...
    from PyPDF2.types import FitType, ZoomArgType

    @staticmethod
    def text(
        rect: RectangleObject | tuple[float, float, float, float],
        text: str,
        open: bool = False,
        flags: int = 0,
    ) -> DictionaryObject:
    ...
    def link(
        ...
        """
        from PyPDF2.types import BorderArrayType
