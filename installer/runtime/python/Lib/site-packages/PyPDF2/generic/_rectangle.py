...
from PyPDF2._utils import deprecation_no_replacement, deprecation_with_replacement
...
class RectangleObject(ArrayObject):
    ...
    def _ensure_is_number(self, value: Any) -> FloatObject | NumberObject:
    ...
    def ensureIsNumber(
        self, value: Any
    ) -> FloatObject | NumberObject:  # pragma: no cover
