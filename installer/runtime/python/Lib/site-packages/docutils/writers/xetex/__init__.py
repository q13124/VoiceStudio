...
\\setmonofont[HyphenChar=None,Scale=MatchLowercase]{DejaVu Sans Mono}"""
    ...
    settings_spec = frontend.filter_settings_spec(
        ...
        'font_encoding',
        # changed settings:
        template=(f'Template file. Default: "{default_template}".',
                  ['--template'],
...
class Babel(latex2e.Babel):
    ...
    def __call__(self):
        setup = [r'\usepackage{polyglossia}',
                 rf'\setdefaultlanguage{{{self.language}}}']
        if self.otherlanguages:
            setup.append(r'\setotherlanguages{{{}}}'.format(','.join(sorted(self.otherlanguages.keys()))))
        return '\n'.join(setup)
...
class XeLaTeXTranslator(latex2e.LaTeXTranslator):
    ...
    def __init__(self, document) -> None:
        ...
        if self.latex_encoding == 'utf8':
            ...
            self.requirements['_inputenc'] = (rf'\XeTeXinputencoding {self.latex_encoding} ')
