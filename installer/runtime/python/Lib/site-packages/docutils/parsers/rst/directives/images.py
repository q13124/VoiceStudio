        ...
        if 'align' in self.options:
            if isinstance(self.state, states.SubstitutionDef):
                ...
                if self.options['align'] not in self.align_v_values:
                    raise self.error(
                        'Error in "{}" directive: "{}" is not a valid value '
                        'for the "align" option within a substitution '
                        'definition.  Valid values for "align" are: "{}".'.format(self.name, self.options['align'],
                           '", "'.join(self.align_v_values)))
            elif self.options['align'] not in self.align_h_values:
                raise self.error(
                    'Error in "{}" directive: "{}" is not a valid value for '
                    'the "align" option.  Valid values for "align" are: "{}".'.format(self.name, self.options['align'],
