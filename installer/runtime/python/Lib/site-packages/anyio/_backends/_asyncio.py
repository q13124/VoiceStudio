...
from anyio import CapacityLimiterStatistics, EventStatistics, LockStatistics, TaskInfo, abc
from anyio._core._eventloop import claim_worker_thread, set_current_async_library, threadlocals
from anyio._core._exceptions import (
    BrokenResourceError,
    BusyResourceError,
    ClosedResourceError,
    EndOfStream,
...
from anyio._core._synchronization import CapacityLimiter as BaseCapacityLimiter
from anyio._core._synchronization import Event as BaseEvent
from anyio._core._synchronization import Lock as BaseLock
from anyio._core._synchronization import ResourceGuard, SemaphoreStatistics
from anyio._core._synchronization import Semaphore as BaseSemaphore
from anyio._core._tasks import CancelScope as BaseCancelScope
...
from anyio.abc._eventloop import StrOrBytesPath
...
class AsyncIOTaskInfo(TaskInfo):
    def __init__(self, task: asyncio.Task):
        ...
        parent_id = None if task_state is None else task_state.parent_id
