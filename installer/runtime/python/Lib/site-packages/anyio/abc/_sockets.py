...
from anyio._core._typedattr import TypedAttributeProvider, TypedAttributeSet, typed_attribute
...
class _SocketProvider(TypedAttributeProvider):
    ...
    def extra_attributes(self) -> Mapping[Any, Callable[[], Any]]:
        from anyio._core._sockets import convert_ipv6_sockaddr as convert
