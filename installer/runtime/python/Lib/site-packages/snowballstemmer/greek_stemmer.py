        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    if among_var == 0:
                        raise lab3()
                    if among_var == 1 and not self.slice_from("αγ"):
                        return False
                    raise lab2()
                except lab3: pass
                self.cursor = self.limit - v_2
