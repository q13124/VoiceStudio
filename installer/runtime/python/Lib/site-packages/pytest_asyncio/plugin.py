...
def pytest_configure(config: Config) -> None:
    ...
    if not default_fixture_loop_scope:
        warnings.warn(PytestDeprecationWarning(_DEFAULT_FIXTURE_LOOP_SCOPE_UNSET), stacklevel=2)
...
def _get_marked_loop_scope(
    ...
    if "scope" in asyncio_marker.kwargs:
        ...
        warnings.warn(PytestDeprecationWarning(_MARKER_SCOPE_KWARG_DEPRECATION_WARNING), stacklevel=2)
