...
class DebugApplicationNode(DebugDocumentProvider):
    ...
    _public_methods_ = (
        ["EnumChildren", "GetParent", "SetDocumentProvider", "Close", "Attach", "Detach", *DebugDocumentProvider._public_methods_]
    )
...
class DebugDocumentTextEvents:
    _public_methods_ = ["onDestroy", "onInsertText", "onRemoveText", "onReplaceText", "onUpdateTextAttributes", "onUpdateDocumentAttributes"]
