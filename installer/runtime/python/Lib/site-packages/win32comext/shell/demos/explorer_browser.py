...
IExplorerBrowserEvents_Methods = ["OnNavigationComplete", "OnNavigationFailed", "OnNavigationPending", "OnViewCreated"]
...
class MainWindow:
    def __init__(self):
        ...
        (shellcon.FVM_LIST, shellcon.FWF_AUTOARRANGE | shellcon.FWF_NOWEBVIEW)
