...
class ColumnProvider:
    ...
    def GetColumnInfo(self, index):
        ...
        if index in [0, 1]:
            ...
            ext = ".pyc" if index == 0 else ".pyo"
            title = ext + " size"
            description = f"Size of compiled {ext} file"
    ...
    def GetItemData(self, colid, colData):
        ...
        _flags, _attr, _reserved, ext, name = colData
        if ext.lower() not in [".py", ".pyw"]:
            return None
        ext = ".pyc" if pid == 0 else ".pyo"
