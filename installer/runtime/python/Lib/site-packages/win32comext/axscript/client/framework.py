...
class EventSink:
    ...
    def BuildEvents(self):
        ...
        for item in range(numTypeInfos):
            if isMulti:
                typeinfo, _flags = mainTypeInfo.GetInfoOfIndex(
...
class ScriptItem:
    ...
    def FindBuildSubItemEvents(self):
        ...
        try:
            ...
            return
        for item in range(numTypeInfos):
            typeinfo, _flags = multiTypeInfo.GetInfoOfIndex(
                item, axscript.MULTICLASSINFO_GETTYPEINFO
            )
...
class COMScript:
    ...
    def ChangeScriptState(self, state):
        ...
        try:
            ...
            try:
                ...
                (_hr, _desc, _exc, _arg) = xxx_todo_changeme.args
        finally:
    ...
    def CompileInScriptedSection(
        ...
        if codeBlock.codeObject is not None:  # already compiled
            return 1
        code = codeBlock.codeText if realCode is None else realCode
