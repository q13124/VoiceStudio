...
PATH_SAFE = "".join(
    [
        ...
        if i not in (32, 34, 35, 60, 62, 63, 96, 123, 125)
    ]
)
...
USERNAME_SAFE = "".join(
    [
        ...
        for i in range(0x20, 0x7F)
        if i
        not in (32, 34, 35, 60, 62, 63, 96, 123, 125, 47, 58, 59, 61, 64, 91, 92, 93, 94, 124)
    ]
)
PASSWORD_SAFE = "".join(
    [
...
USERINFO_SAFE = "".join(
    [
        ...
        for i in range(0x20, 0x7F)
        if i
        not in (32, 34, 35, 60, 62, 63, 96, 123, 125, 47, 59, 61, 64, 91, 92, 93, 94, 124)
    ]
)
