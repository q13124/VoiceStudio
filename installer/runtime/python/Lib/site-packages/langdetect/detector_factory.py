    ...
    def load_profile(self, profile_directory):
        ...
        for filename in list_files:
            ...
            try:
                ...
                raise LangDetectException(ErrorCode.FileLoadError, f'Cannot open "{filename}"')
            except:
                raise LangDetectException(ErrorCode.FormatError, f'Profile format error in "{filename}"')
            finally:
                if f:
                    f.close()
