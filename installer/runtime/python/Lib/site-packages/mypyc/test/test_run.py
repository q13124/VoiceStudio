    ...
    def run_case_step(self, testcase: DataDrivenTestCase, incremental_step: int) -> None:
        ...
        try:
            ...
            if errors.num_errors:
                errors.flush_errors()
                raise AssertionError("Compile error")
        ...
        if debugger:
            if debugger == "lldb":
                ...
                raise AssertionError("Unsupported debugger")
            # TODO: find a way to automatically disable capturing
            # stdin/stdout when in debugging mode
            raise AssertionError("Test can't pass in debugging mode. " "(Make sure to pass -s to pytest to interact with the debugger)")
