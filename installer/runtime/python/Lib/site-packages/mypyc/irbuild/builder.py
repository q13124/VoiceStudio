...
class IRBuilder:
    ...
    def accept(self, node: Statement | Expression, *, can_borrow: bool = False) -> Value | None:
        ...
        with self.catch_errors(node.line):
            if isinstance(node, Expression):
                ...
                with suppress(UnsupportedException):
    ...
    def init_final_static(
        ...
        *,
        ...
        if lvalue.node.final_value is None:
            name = lvalue.name if class_name is None else f"{class_name}.{lvalue.name}"
    ...
    def get_assignment_target(
        ...
        if isinstance(lvalue, NameExpr):
            ...
            if lvalue.kind == LDEF:
                ...
                raise AssertionError(lvalue.kind)
        ...
        raise AssertionError(f"Unsupported lvalue: {lvalue!r}")
    ...
    def read(
        ...
        *,
        ...
        if isinstance(target, AssignmentTargetIndex):
            ...
            if reg is not None:
                return reg
            raise AssertionError(target.base.type)
        ...
        raise AssertionError(f"Unsupported lvalue: {target!r}")
    ...
    def assign(self, target: Register | AssignmentTarget, rvalue_reg: Value, line: int) -> None:
        if isinstance(target, Register):
            ...
            raise AssertionError("Unsupported assignment target")
    ...
    def get_dict_base_type_from_type(self, target_type: Type) -> list[Instance]:
        ...
        if isinstance(target_type, TypedDictType):
            ...
            raise AssertionError(f"Failed to extract dict base from {target_type}")
