...
class IRBuilderVisitor(IRVisitor):
    ...
    def visit_type_form_expr(self, o: TypeFormExpr) -> Value:
        raise AssertionError("TypeFormExpr should have been handled in CallExpr")
    ...
    def visit_star_expr(self, o: StarExpr) -> Value:
        raise AssertionError("should have been handled in Tuple/List/Set/DictExpr or CallExpr")
