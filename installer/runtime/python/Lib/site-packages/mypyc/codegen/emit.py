...
class Emitter:
        ...
        *,
        ...
        if rtuple.error_overlap:
            ...
            for i, typ in enumerate(rtuple.types):
                ...
                raise AssertionError("not expecting tuple with error overlap")
        ...
        *,
        ...
        if (
            ...
            if is_list_rprimitive(typ):
                ...
                raise AssertionError(f"unexpected primitive type: {typ}")
            check = "({}_Check({}))"
            if likely:
                check = f"(likely{check})"
            ...
            raise AssertionError(f"Cast not implemented: {typ}")
    ...
    def emit_unbox(
        ...
        *,
        ...
        if is_int_rprimitive(typ) or is_short_int_rprimitive(typ):
            ...
            raise AssertionError(f"Unboxing not implemented: {typ}")
    ...
    def emit_box(
        ...
        declaration = "PyObject *" if declare_dest else ""
        if is_int_rprimitive(typ) or is_short_int_rprimitive(typ):
    ...
    def emit_gc_visit(self, target: str, rtype: RType) -> None:
        ...
        if not rtype.is_refcounted:
            ...
            raise AssertionError(f"emit_gc_visit() not implemented for {rtype!r}")
    ...
    def emit_gc_clear(self, target: str, rtype: RType) -> None:
        ...
        if not rtype.is_refcounted:
            ...
            raise AssertionError(f"emit_gc_clear() not implemented for {rtype!r}")
