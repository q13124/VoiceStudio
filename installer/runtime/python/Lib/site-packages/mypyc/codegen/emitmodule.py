...
class GroupGenerator:
    ...
    def generate_shared_lib_init(self, emitter: Emitter) -> None:
        ...
        for mod in self.modules:
            ...
            emitter.emit_lines(
                f'capsule = PyCapsule_New((void *){capsule_func_prefix}{name}, "{shared_lib_name(self.group_name)}.{capsule_name_prefix}{name}", NULL);',
                "if (!capsule) {",
                "goto fail;",
                "}",
    ...
    def declare_global(
        ...
        defn = None if not initializer else [f"{base} = {initializer};"]
