...
class MemorizedFunc(Logger):
    ...
    def __init__(
        ...
        self.store_backend = _store_backend_factory(
            ...
            location,
            verbose=verbose,
            backend_options={"compress": compress, "mmap_mode": mmap_mode},
        )
        ...
        if inspect.isfunction(func):
            ...
            doc = func.__doc__
        self.__doc__ = f"Memoized version of {doc}"
    ...
    def clear(self, warn=True):
        ...
        if self._verbose > 0 and warn:
            self.warn(f"Clearing function cache identified by {func_id}")
    ...
    def _persist_input(self, duration, call_id, args, kwargs, this_duration_limit=0.5):
        ...
        if this_duration > this_duration_limit:
            ...
            warnings.warn(
                f"Persisting input arguments took {this_duration:.2f}s to run."
