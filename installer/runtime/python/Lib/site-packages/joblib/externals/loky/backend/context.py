...
def cpu_count(only_physical_cores=False):
    ...
    if exception is not None:
        ...
        warnings.warn(
            ...
            "the number of cores you want to use.", stacklevel=2
        )
    ...
    try:
        ...
        if (
            ...
            warnings.warn(
                ...
                "Please install psutil or explictly set LOKY_MAX_CPU_COUNT.", stacklevel=2
            )
...
def _count_physical_cores_linux():
    try:
        cpu_info = subprocess.run(
            ["lscpu", "--parse=core"], capture_output=True, text=True
        )
