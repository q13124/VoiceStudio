...
def _is_object(obj):
    ...
    if isinstance(obj, POINTER(IUnknown)) or (isinstance(obj, VARIANT) and isinstance(obj.value, POINTER(IUnknown))):
        return True
...
def CoGetObject(displayname: str, interface: type[IUnknown] | None) -> IUnknown:
