    ...
    def compile(self):
        ...
        if not os.path.isfile(idl_path) or open(idl_path).read() != code:
            ...
            os.system(
                ...
                rf"midl /nologo {idl_path} /tlb {tlb_path}"
            )
        ...
        _guid, _major, _minor = attr.guid, attr.wMajorVerNum, attr.wMinorVerNum
...
class MyServer(comtypes.CoClass, ConnectableObjectMixin):
    ...
    def test_GetStackTrace(self):
        ...
        frames = (c_int * 5)()
        p.GetStackTrace(42, frames, 5)
        ##        print "RES_1", res

        frames = pointer(c_int(5))
        p.GetStackTrace(42, frames, 0)
    ...
    def test_events(self):
        ...
        handler = Handler()
        comtypes.client.GetEvents(p, handler)
        p.DoSomething()
