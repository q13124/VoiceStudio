...
class TestComServer(
    ...
    _com_interfaces_ = [*TestComServerLib.TestComServer._com_interfaces_, comtypes.typeinfo.IProvideClassInfo2, comtypes.errorinfo.ISupportErrorInfo, comtypes.connectionpoints.IConnectionPointContainer]
