...
################################################################
def run_test(rep, msg, func=None, previous=None, results=None):
    # items = [None] * rep
    if results is None:
        results = {}
    if previous is None:
...
if __name__ == "__main__":
    ...
    print(
        f"Running benchmark with comtypes {comtypes.__version__}/Python {sys.version.split()[0]} ..."
    )
    check_perf()
