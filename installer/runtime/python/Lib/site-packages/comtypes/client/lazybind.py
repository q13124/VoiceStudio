...
class NamedProperty:
    ...
    def __setitem__(self, name, value):
        ...
        descr = self.putref or self.put if comtypes._is_object(value) else self.put or self.putref
...
class Dispatch:
    ...
    def __setattr__(self, name, value):
        ...
        if not put and not putref:
            raise AttributeError(name)
        descr = putref or put if comtypes._is_object(value) else put or putref
        if descr.cParams == 1:
    ...
    def __setitem__(self, name, value):
        invkind = DISPATCH_PROPERTYPUTREF if comtypes._is_object(value) else DISPATCH_PROPERTYPUT
