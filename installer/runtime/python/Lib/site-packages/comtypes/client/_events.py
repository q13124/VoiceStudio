...
class _AdviseConnection:
    cp: IConnectionPoint | None
    cookie: int | None
    receiver: _ReceiverType | None
...
def GetEvents(
    source: IUnknown, sink: Any, interface: type[IUnknown] | None = None
) -> _AdviseConnection:
...
def ShowEvents(
    source: IUnknown, interface: type[IUnknown] | None = None
) -> _AdviseConnection:
