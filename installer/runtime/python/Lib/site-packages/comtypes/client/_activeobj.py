...
#
@overload
def GetActiveObject(progid: str | type[CoClass] | GUID) -> Any: ...
@overload
def GetActiveObject(
    progid: str | type[CoClass] | GUID, interface: type[_T_IUnknown]
) -> _T_IUnknown: ...
def GetActiveObject(
...
def RegisterActiveObject(
    punk: IUnknown, progid: str | type[CoClass] | GUID, weak: bool = True
) -> int:
    clsid = GUID.from_progid(progid)
