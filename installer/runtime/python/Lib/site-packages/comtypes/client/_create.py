...
def CreateObject(
    progid: str | type[CoClass] | GUID,  # which object to create
    clsctx: int | None = None,  # how to create the object
    machine: str | None = None,  # where to create the object
    interface: type[IUnknown] | None = None,  # the interface we want
    dynamic: bool = False,  # use dynamic dispatch
    pServerInfo: COSERVERINFO | None = None,  # server info struct for remoting
) -> Any:
