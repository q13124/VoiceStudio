...
class External:
    def __init__(
        ...
        size: int,
        align: int,
        docs: tuple[str, str | None] | None = None,
    ) -> None:
...
class ComMethod:
    ...
    def __init__(
        ...
        self.memid = memid
        self.doc = doc
        self.arguments: list[tuple[Any, str, list[str], Any | None]] = []
...
class DispInterface:
    def __init__(
        ...
        self.name = name
        self.members: list[DispMethod | DispProperty] = []
        self.base = base
        self.iid = iid
        self.idlflags = idlflags
