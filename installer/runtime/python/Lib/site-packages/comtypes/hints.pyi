...
import comtypes
from comtypes import GUID as GUID
from comtypes import COMObject as COMObject
from comtypes import IUnknown as IUnknown
from comtypes._safearray import tagSAFEARRAY as tagSAFEARRAY
from comtypes.automation import VARIANT as VARIANT
from comtypes.automation import IDispatch as IDispatch
...
from comtypes.typeinfo import ITypeLib as ITypeLib
...
) -> Callable[_P_Put, _R_Put] | Callable[_P_PutRef, _R_PutRef]: ...
...
class _GetSetNormalProperty(Generic[_T_Inst, _R_Get, _T_SetVal]):
    ...
    @overload
    def __get__(
        self, instance: _T_Inst, owner: type[_T_Inst] | None, /
    ) -> _R_Get: ...
...
@overload
def to_dunder_iter(
    newenum: _Descriptor[_T_Inst, Iterator[_T_E]] | Callable[[_T_Inst], Iterator[_T_E]],
...
@overload
def to_dunder_call(
    item: _GetSetNamedProperty[_T_Inst, _P_Get, _R_Get, ...] | _GetOnlyNamedProperty[_T_Inst, _P_Get, _R_Get] | Callable[Concatenate[_T_Inst, _P_Get], _R_Get],
...
def to_dunder_setitem(
    item: _GetSetNamedProperty[_T_Inst, ..., Any, _P_Set] | _SetOnlyNamedProperty[_T_Inst, _P_Set],
) -> Callable[Concatenate[_T_Inst, _P_Set], Any]: ...
@overload
def to_dunder_setitem(item: Any) -> Callable[..., NoReturn]: ...

_PosParamFlagType: TypeAlias = tuple[int, str | None]
_OptParamFlagType: TypeAlias = tuple[int, str | None, Any]
ParamFlagType: TypeAlias = _PosParamFlagType | _OptParamFlagType
...
ArgSpecElmType: TypeAlias = _PosArgSpecElmType | _OptArgSpecElmType
