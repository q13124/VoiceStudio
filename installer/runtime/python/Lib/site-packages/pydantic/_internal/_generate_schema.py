...
from pydantic.config import ConfigDict, JsonDict, JsonEncoder, JsonSchemaExtraCallable
...
class GenerateSchema:
    ...
    def _generate_schema_from_get_schema_method(self, obj: Any, source: Any) -> core_schema.CoreSchema | None:
        ...
        if (
            ...
            ref_mode = 'unpack' if obj is source else 'to-def'
            schema = get_schema(
    ...
    def _arguments_schema(
        ...
        for i, (name, p) in enumerate(sig.parameters.items()):
            annotation = typing.cast(Any, Any) if p.annotation is sig.empty else type_hints[name]
