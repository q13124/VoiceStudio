...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def copy(
        ...
        *,
        ...
        fields_set = self.__fields_set__ | update.keys() if update else set(self.__fields_set__)
    ...
    def validate(cls: type['Model'], value: Any) -> 'Model':
        if isinstance(value, cls):
            ...
            if copy_on_model_validation not in {'deep', 'shallow', 'none'}:
                ...
                warnings.warn(
                    "`copy_on_model_validation` should be a string: 'deep', 'shallow' or 'none'", DeprecationWarning, stacklevel=2
                )
...
def create_model(
    ...
    **field_definitions: Any,
    ...
    if __slots__ is not None:
        ...
        warnings.warn('__slots__ should not be passed to create_model', RuntimeWarning, stacklevel=2)
    ...
    for f_name, f_def in field_definitions.items():
        if not is_valid_field(f_name):
            warnings.warn(f'fields may not start with an underscore, ignoring "{f_name}"', RuntimeWarning, stacklevel=2)
