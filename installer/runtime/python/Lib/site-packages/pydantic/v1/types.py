...
def confloat(
    *,
    ...
    # use kwargs then define conf in a dict to aid with IDE type hinting
    namespace = {'strict': strict, 'gt': gt, 'ge': ge, 'lt': lt, 'le': le, 'multiple_of': multiple_of, 'allow_inf_nan': allow_inf_nan}
...
class ConstrainedStr(str):
    ...
    def validate(cls, value: str) -> str:
        ...
        if cls.regex and not re.match(cls.regex, value):
...
def conlist(
    item_type: type[T], *, min_items: int | None = None, max_items: int | None = None, unique_items: bool | None = None
) -> type[list[T]]:
    # __args__ is needed to conform to typing generics api
    namespace = {
