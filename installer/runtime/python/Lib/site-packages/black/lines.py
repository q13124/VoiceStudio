...
class Line:
    ...
    def _is_triple_quoted_string(self) -> bool:
        ...
        if value.startswith(('"""', "'''")):
            return True
        return bool(value.startswith(("r'''", 'r"""', "R'''", 'R"""')))
    ...
    def contains_uncollapsable_type_comments(self) -> bool:
        ...
        for leaf_id, comments in self.comments.items():
            for comment in comments:
                if is_type_comment(comment, mode=self.mode) and (comment_seen or (
    ...
    def has_magic_trailing_comma(self, closing: Leaf) -> bool:
        ...
        return bool(closing.opening_bracket is not None and not is_one_sequence_between(closing.opening_bracket, closing, self.leaves))
