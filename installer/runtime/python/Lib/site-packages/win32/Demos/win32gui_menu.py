...
class MainWindow:
    ...
    def createMenu(self):
        ...
        item, _extras = PackMENUITEMINFO(text="Sub-Menu", hSubMenu=sub_menu)
        InsertMenuItem(menu, 0, 1, item)
    ...
    def OnMeasureItem(self, hwnd, msg, wparam, lparam):
        ...
        ctlType, ctlID, itemID, _itemWidth, _itemHeight, itemData = data

        _hicon, text = self.menu_item_map[itemData]
        if text is None:
