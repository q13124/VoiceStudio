...
def GroupEnum():
    ...
    while 1:
        ...
        for group in data:
            ...
            memberresume = 0
            while 1:
                memberdata, _total, memberresume = win32net.NetGroupGetUsers(
...
def LocalGroupEnum():
    ...
    while 1:
        ...
        for group in data:
            ...
            memberresume = 0
            while 1:
                memberdata, _total, memberresume = win32net.NetLocalGroupGetMembers(
...
def ServerEnum():
    ...
    while 1:
        ...
        for s in data:
            ...
            shareresume = 0
            while 1:
                sharedata, _total, shareresume = win32net.NetShareEnum(
...
def LocalGroup(uname=None):
    ...
    try:
        ...
        mem, _tot, _res = win32net.NetLocalGroupGetMembers(server, group, level)
...
def SetInfo(userName=None):
    ...
    try:
        ...
        if str(new) != "Test comment":
            raise RuntimeError(f"Could not read the same comment back - got {new}")
...
def SetComputerInfo():
    ...
    win32net.NetWkstaGetInfo(None, 502)
...
def usage(tests):
    ...
    print(f"Usage: {os.path.basename(sys.argv[0])} [-s server ] [-v] [Test ...]")
    ...
    if len(args) == 0:
        ...
        for arg in args:
            for t in tests:
                ...
                print(f"Test '{arg}' unknown - skipping")
    if not len(dotests):
        print("Nothing to do!")
        usage(tests)
    for test in dotests:
