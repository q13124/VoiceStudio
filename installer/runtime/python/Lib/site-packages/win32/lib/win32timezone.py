...
class _SimpleStruct:
    ...
    def __eq__(self, other) -> bool:
        ...
        if self._fields_ != other._fields_:
            return False
        return all(getattr(self, name) == getattr(other, name) for name, _ in self._fields_)
...
class TimeZoneInfo(datetime.tzinfo):
    ...
    def _get_indexed_time_zone_keys(index_key="Index"):
        ...
        return (
            (value, key_name) for value, key_name in zip(values, key_names, strict=False) if value
        )
