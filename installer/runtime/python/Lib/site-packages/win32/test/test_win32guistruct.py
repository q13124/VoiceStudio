...
class TestMenuItemInfo(TestBase):
    def _testPackUnpack(self, text):
        ...
        mii, _extras = win32gui_struct.PackMENUITEMINFO(**vals)
        (
            fType,
            fState,
            wID,
    ...
    def testEmptyMenuItemInfo(self):
        mii, _extra = win32gui_struct.EmptyMENUITEMINFO()
        (
            fType,
            fState,
            wID,
...
class TestTreeViewItem(TestBase):
    def _testPackUnpack(self, text):
        ...
        ti, _extra = win32gui_struct.PackTVITEM(**vals)
        (
            hitem,
            state,
            stateMask,
    ...
    def testEmpty(self):
        ti, _extras = win32gui_struct.EmptyTVITEM(0)
        (
            hitem,
            state,
            stateMask,
...
class TestListViewItem(TestBase):
    def _testPackUnpack(self, text):
        ...
        ti, _extra = win32gui_struct.PackLVITEM(**vals)
        (
            item,
            subItem,
            state,
    ...
    def testEmpty(self):
        ti, _extras = win32gui_struct.EmptyLVITEM(1, 2)
        (
            item,
            subItem,
            state,
...
class TestLVColumn(TestBase):
    def _testPackUnpack(self, text):
        ...
        ti, _extra = win32gui_struct.PackLVCOLUMN(**vals)
    ...
    def testEmpty(self):
        ti, _extras = win32gui_struct.EmptyLVCOLUMN()
        fmt, cx, text, subItem, image, order = win32gui_struct.UnpackLVCOLUMN(ti)
