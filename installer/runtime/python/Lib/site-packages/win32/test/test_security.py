...
class TestDS(DomainTests):
    ...
    def testDsListServerInfo(self):
        ...
        for _status, _ignore, site in win32security.DsListSites(h):
            for _status, _ignore, server in win32security.DsListServersInSite(h, site):
                win32security.DsListInfoForServer(h, server)
            for _status, _ignore, _domain in win32security.DsListDomainsInSite(h, site):
                pass
