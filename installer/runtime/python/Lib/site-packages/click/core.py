...
class Context:
    ...
    def __init__(
        ...
        default_map: t.MutableMapping[str, t.Any] | None = None,
        ...
        self.default_map: t.MutableMapping[str, t.Any] | None = default_map
        ...
        if help_option_names is None:
            help_option_names = parent.help_option_names if parent is not None else ["--help"]
    ...
    def invoke(
        ...
        **kwargs: t.Any,
        ...
        with augment_usage_errors(__self), ctx:
...
class Group(MultiCommand):
    ...
    def __init__(
        self,
        name: str | None = None,
        commands: t.MutableMapping[str, Command] | t.Sequence[Command] | None = None,
        **attrs: t.Any,
    ) -> None:
        super().__init__(name, **attrs)
...
class Argument(Parameter):
    ...
    def __init__(
        ...
        **attrs: t.Any,
        ...
        if required is None:
            required = False if attrs.get("default") is not None else attrs.get("nargs", 1) > 0
