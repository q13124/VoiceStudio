...
class ExternallyManagedEnvironment(DiagnosticPipError):
    ...
    def __init__(self, error: str | None) -> None:
        context = Text(_DEFAULT_EXTERNALLY_MANAGED_ERROR) if error is None else Text(error)
        super().__init__(
...
class InvalidInstalledPackage(DiagnosticPipError):
    ...
    def __init__(
        ...
        *,
        ...
        invalid_type = "requirement" if isinstance(invalid_exc, InvalidRequirement) else "version"
