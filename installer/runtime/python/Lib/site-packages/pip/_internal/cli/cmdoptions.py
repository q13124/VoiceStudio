...
def check_dist_restriction(options: Values, check_target: bool = False) -> None:
    ...
    if check_target and not options.dry_run and dist_restriction_set and not options.target_dir:
        raise CommandError(
...
use_new_feature: Callable[..., Option] = partial(
    ...
    action="append",
    default=[],
    choices=["fast-deps", "build-constraint", "inprocess-build-deps", *ALWAYS_ENABLED_FEATURES],
