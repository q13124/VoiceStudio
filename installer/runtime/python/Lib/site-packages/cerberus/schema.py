...
class DefinitionSchema(MutableMapping):
    ...
    def __delitem__(self, key):
        ...
        try:
            ...
            raise SchemaError(f"Schema has no field '{key}' defined")
    ...
    def _expand_logical_shortcuts(cls, schema):
        ...
        for _field, rules in schema.items():
    ...
    def _rename_deprecated_rulenames(schema):
        for field, rules in schema.items():
            ...
            for old, new in (
                ...
                warn(
                    f"The rule '{old}' was renamed to '{new}'. The old name will "
...
class SchemaValidatorMixin:
    ...
    def _check_with_type(self, field, value):
        value = {value} if isinstance(value, _str_type) else set(value)
