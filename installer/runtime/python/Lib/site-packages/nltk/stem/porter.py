...
class PorterStemmer(StemmerI):
    ...
    def _step1a(self, word):
        ...
        if self.mode == self.NLTK_EXTENSIONS and word.endswith("ies") and len(word) == 4:
    ...
    def _step1b(self, word):
        ...
        if self.mode == self.NLTK_EXTENSIONS and word.endswith("ied"):
            if len(word) == 4:
...
def demo():
    ...
    for item in treebank.fileids()[:3]:
        for word, _tag in treebank.tagged_words(item):
            orig.append(word)
