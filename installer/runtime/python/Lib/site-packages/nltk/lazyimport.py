...
class LazyModule:
    ...
    def __lazymodule_import(self):
        ...
        if _debug:
            print(f"LazyModule: Loading module {full_name!r}")
        ...
        if _debug:
            print(f"LazyModule: Module {full_name!r} loaded")
        return module
    ...
    def __getattr__(self, name):
        ...
        if _debug:
            print(
                "LazyModule: "
                f"Module load triggered by attribute {name!r} read access"
            )
    ...
    def __setattr__(self, name, value):
        ...
        if _debug:
            print(
                "LazyModule: "
                f"Module load triggered by attribute {name!r} write access"
            )
        module = self.__lazymodule_import()
