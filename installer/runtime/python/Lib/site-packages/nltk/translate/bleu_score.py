...
def corpus_bleu(
    ...
    for references, hypothesis in zip(list_of_references, hypotheses, strict=False):
    ...
    for weight in weights:
        ...
        if auto_reweigh and hyp_lengths < 4 and weight == (0.25, 0.25, 0.25, 0.25):
            weight = (1 / hyp_lengths,) * hyp_lengths

        s = (w_i * math.log(p_i) for w_i, p_i in zip(weight, p_n, strict=False) if p_i > 0)
