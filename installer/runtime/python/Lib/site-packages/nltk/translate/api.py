...
class AlignedSent:
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        words = "[{}]".format(", ".join(f"'{w}'" for w in self._words))
        mots = "[{}]".format(", ".join(f"'{w}'" for w in self._mots))
    ...
    def _to_dot(self):
        ...
        s += "{{rank = same; {}}}\n".format(" ".join(f'"{w}_source"' for w in self._words))
        s += "{{rank = same; {}}}\n".format(" ".join(f'"{w}_target"' for w in self._mots))
    ...
    def _repr_svg_(self):
        ...
        out, _err = process.communicate(dot_string)
...
class Alignment(frozenset):
    ...
    def __repr__(self):
        ...
        """
        return f"Alignment({sorted(self)!r})"
