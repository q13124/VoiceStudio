                ...
                while j > i:
                    ...
                    if isinstance(a, NegatedExpression):
                        if a.term == b:
                            ...
                            return True
                    elif isinstance(b, NegatedExpression) and a == b.term:
                        self._is_tautology = True
                        return True
                    j -= 1
...
def _clausify(expression):
    ...
    elif isinstance(expression, (EqualityExpression, ApplicationExpression)):
        return [Clause([expression])]
    elif isinstance(expression, NegatedExpression):
        if isinstance(expression.term, (ApplicationExpression, EqualityExpression)):
            return [Clause([expression])]
...
class BindingException(Exception):
    def __init__(self, arg):
        if isinstance(arg, tuple):
            Exception.__init__(self, "'{}' cannot be bound to '{}'".format(*arg))
        else:
