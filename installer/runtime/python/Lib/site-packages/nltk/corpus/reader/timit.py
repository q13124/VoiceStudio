...
class TimitCorpusReader(CorpusReader):
    ...
    def fileids(self, filetype=None):
        ...
        if filetype is None:
            ...
            raise ValueError(f"Bad value for filetype: {filetype!r}")
    ...
    def phone_trees(self, utterances=None):
        ...
        for utterance in utterances:
            ...
            while sent_times:
                (_sent, _sent_start, sent_end) = sent_times.pop(0)
                trees.append(Tree("S", []))
                while (
                ...
                while word_times and word_times[0][2] <= sent_end:
                    (word, _word_start, word_end) = word_times.pop(0)
...
class SpeakerInfo:
    ...
    def __repr__(self):
        ...
        return "SpeakerInfo({})".format(", ".join(args))
