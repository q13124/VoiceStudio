...
class SensevalInstance:
    ...
    def __repr__(self):
        return f"SensevalInstance(word={self.word!r}, position={self.position!r}, " f"context={self.context!r}, senses={self.senses!r})"
                ...
                for cword in child:
                    ...
                    if cword.tag == "head":
                        ...
                        if cword.text.strip():
                            ...
                            raise AssertionError("expected CDATA or wf in <head>")
                    elif cword.tag == "wf":
                        ...
                        print("ACK", cword.tag)
                        raise AssertionError("expected CDATA or <wf> or <head>")
                    if cword.tail:
