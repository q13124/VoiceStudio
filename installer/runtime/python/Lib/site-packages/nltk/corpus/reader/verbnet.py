...
class VerbnetCorpusReader(XMLCorpusReader):
        ...
        if classid in self._class_to_fileid:
            ...
            if classid == tree.get("ID"):
                ...
                for subclass in tree.findall(".//VNSUBCLASS"):
                    ...
                    raise AssertionError()  # we saw it during _index()!
            ...
            with self.open(fileid) as fp:
                for m in self._INDEX_RE.finditer(fp.read()):
                    ...
                    if groups[0] is not None:
                        ...
                        raise AssertionError("unexpected match condition")
    ...
    def longid(self, shortid):
        ...
        if self._LONGID_RE.match(shortid):
            ...
            raise ValueError(f"vnclass identifier {shortid!r} not found")
        try:
            return self._shortid_to_longid[shortid]
        except KeyError as e:
            raise ValueError(f"vnclass identifier {shortid!r} not found") from e
    ...
    def shortid(self, longid):
        ...
        if m:
            ...
            raise ValueError(f"vnclass identifier {longid!r} not found")
    ...
    def _get_example_within_frame(self, vnframe):
        ...
        example_text = example_element.text if example_element is not None else ""
        return example_text
