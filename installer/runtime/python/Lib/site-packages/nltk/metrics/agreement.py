...
class AnnotationTask:
    ...
    def __str__(self):
        return "\r\n".join(
            "{}\t{}\t{}".format(x["coder"], x["item"].replace("_", "\t"), ",".join(x["labels"])) for x in self.data
        )
    ...
    def Do_Kw_pairwise(self, cA, cB, max_distance=1.0):
        ...
        for _i, itemdata in self._grouped_data("item", data):
    ...
    def alpha(self):
        ...
        for _i, itemdata in self._grouped_data("item"):
