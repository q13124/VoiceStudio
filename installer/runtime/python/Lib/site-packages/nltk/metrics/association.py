...
class NgramAssocMeasures(metaclass=ABCMeta):
    ...
    def chi_sq(cls, *marginals):
        ...
        return sum((obs - exp) ** 2 / (exp + _SMALL) for obs, exp in zip(cont, exps, strict=False))
    ...
    def likelihood_ratio(cls, *marginals):
        ...
        return 2 * sum(
            ...
            for obs, exp in zip(cont, cls._expected_values(cont), strict=False)
        )
...
class BigramAssocMeasures(NgramAssocMeasures):
    ...
    def fisher(cls, *marginals):
        ...
        (_odds, pvalue) = fisher_exact([[n_ii, n_io], [n_oi, n_oo]], alternative="less")
        return pvalue
...
class TrigramAssocMeasures(NgramAssocMeasures):
    ...
    def _marginals(*contingency):
        ...
        (1, (1, 1, 1), (1, 73, 1), 2000)
        """
        n_iii, n_oii, n_ioi, n_ooi, n_iio, n_oio, n_ioo, _n_ooo = contingency
        return (
            n_iii,
