...
class MultiListbox(Frame):
    ...
    FRAME_CONFIG = {"background": "#888", "takefocus": True, "highlightthickness": 1}
    ...
    def insert(self, index, *rows):
        ...
        for lb, elts in zip(self._listboxes, list(zip(*rows, strict=False)), strict=False):
    ...
    def get(self, first, last=None):
        ...
        if last:
            return [tuple(row) for row in zip(*values, strict=False)]
        else:
            return tuple(values)
...
class Table:
    ...
    def __init__(
        ...
        **kw
        ...
        self._sortkey = None
        if click_to_sort:
            for _i, l in enumerate(self._mlb.column_labels):
