...
class CFGEditor:
    ...
    def _reset(self, *e):
        ...
        for production in self._cfg.productions():
            self._textwidget.insert("end", f"{production}\n")
        self._analyze()
        if self._set_cfg_callback is not None:
...
def demo2():
    ...
    (S, VP, NP, PP, P, N, _Name, V, Det) = (Nonterminal(s) for s in nonterminals.split())
    productions = (
...
def demo():
    ...
    nonterminals = "S VP NP PP P N Name V Det"
    (_S, _VP, _NP, _PP, _P, _N, _Name, _V, _Det) = (Nonterminal(s) for s in nonterminals.split())
...
def demo3():
    ...
    (S, VP, NP, PP, P, N, _Name, V, Det) = nonterminals(
