...
class ChartView:
    ...
    def _draw_treetok(self, treetok, index, depth=0):
        ...
        for childx, child in zip(child_xs, treetok, strict=False):
...
class ChartParserApp:
    ...
    def load_grammar(self, *args):
        ...
        try:
            ...
            showerror("Error Loading Grammar", f"Unable to open file: {filename!r}")
        ...
        try:
            if filename.endswith(".pickle"):
                ...
                with open(filename, "w") as outfile:
                    ...
                    for prod in start:
                        outfile.write(f"{prod}\n")
                    for prod in rest:
                        outfile.write(f"{prod}\n")
        except Exception:
            showerror("Error Saving Grammar", f"Unable to open file: {filename!r}")
