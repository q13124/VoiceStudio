...
class ShiftReduceApp:
    ...
    def _redraw(self):
        ...
        (_cx1, _cy1, cx2, _cy2) = (int(c) for c in scrollregion)
    ...
    def _animate_shift(self):
        ...
        right = widget.bbox()[0]
        left = 5 if len(self._stackwidgets) == 0 else self._stackwidgets[-1].bbox()[2] + 10
    ...
    def _animate_reduce_frame(self, frame, widgets, dy):
        if frame > 0:
            ...
            (_x1, y1, _x2, y2) = self._stacklabel.bbox()
            y = y2 - y1 + 10
