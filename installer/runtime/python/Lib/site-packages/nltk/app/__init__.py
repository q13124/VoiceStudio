...
try:
    ...
    warnings.warn("nltk.app package not loaded (please install Tkinter library).", stacklevel=2)
else:
    ...
    try:
        ...
        warnings.warn("nltk.app.wordfreq not loaded (requires the matplotlib library).", stacklevel=2)
    else:
