    ...
    def default_config(self, lang):
        ...
        if lang == "ar":
            ...
            try:
                ...
                raise LookupError(
                    f"Could not find '{path_to_dict}' (tried using env. "
            ...
            try:
                ...
                raise LookupError(
                    f"Could not find '{sihan_dir}' (tried using the "
                    "STANFORD_SEGMENTER environment variable)"
                ) from e
        else:
        ...
        try:
            ...
            raise LookupError(
                f"Could not find '{model}' (tried using env. "
                "variables STANFORD_MODELS and <STANFORD_SEGMENTER>/data/)"
            ) from e
