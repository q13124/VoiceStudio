...
def test_ribes_empty_worder():  # worder as in word order
    ...
    hyp = ["This", "is", "a", "nice", "sentence", "which", "I", "quite", "like"]
    ref = ["Okay", "well", "that's", "neat", "and", "all", "but", "the", "reference's", "different"]
...
def test_ribes_one_worder():
    ...
    # correspondence is 0.
    hyp = ["This", "is", "a", "nice", "sentence", "which", "I", "quite", "like"]
    ref = ["Okay", "well", "that's", "nice", "and", "all", "but", "the", "reference's", "different"]
...
def test_ribes_two_worder():
    ...
    hyp = ["This", "is", "a", "nice", "sentence", "which", "I", "quite", "like"]
    ref = ["Okay", "well", "that's", "nice", "and", "all", "but", "the", "reference", "is", "different"]
