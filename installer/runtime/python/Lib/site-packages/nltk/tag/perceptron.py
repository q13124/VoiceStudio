...
class PerceptronTagger(TaggerI):
    ...
    def tag(self, tokens, return_conf=False, use_tagdict=True):
        ...
        for i, word in enumerate(tokens):
            tag, conf = (
                (self.tagdict.get(word), 1.0) if use_tagdict else (None, None)
            )
            if not tag:
    ...
    def train(self, sentences, save_loc=None, nr_iter=5):
        ...
        self._sentences = []  # to be populated by self._make_tagdict...
        ...
        for iter_ in range(nr_iter):
            ...
            for sentence in self._sentences:
                words, tags = zip(*sentence, strict=False)
    ...
    def save_to_json(self, lang="xxx", loc=None):
        ...
        for param, json_file in zip(self.encode_json_obj(), self.param_files(lang), strict=False):
