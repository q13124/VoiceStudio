        ...
        for row in sorted(matrix, reverse=True):
            ...
            if row != max(matrix):
                ...
                branchrow = [
                    ...
                    for a, b in zip(branchrow, [*branchrow[1:], " "], strict=False)
                ]
    ...
    def svg(self, nodecolor="blue", leafcolor="red", funccolor="green"):
        ...
        for node in self.nodes:
            ...
            result.append(
                ...
                f'points="{xmin:g},{y:g} {xmax:g},{y:g}" />'
            )
            result.append(
                '\t<polyline style="stroke:black; stroke-width:1; fill:none;" '
                f'points="{x:g},{y:g} {x:g},{y - fontsize // 3:g}" />'
            )
        ...
        for child, parent in self.edges.items():
            ...
            result += [
                ...
                f' points="{childx:g},{childy:g} {childx:g},{y + 5:g}" />',
                '\t<polyline style="stroke:black; stroke-width:1; fill:none;"'
                f' points="{childx:g},{childy:g} {childx:g},{y:g}" />',
            ]
