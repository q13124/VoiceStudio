...
class WekaClassifier(ClassifierI):
        ...
        try:
            ...
            if stderr and not stdout:
                if "Illegal options: -distribution" in stderr:
                    ...
                    raise ValueError(f"Weka failed to generate output:\n{stderr}")
    ...
    def parse_weka_distribution(self, s):
        ...
        probs = dict(zip(self._formatter.labels(), probs, strict=False))
...
class ARFF_Formatter:
        ...
        for tok, _label in tokens:
            for fname, fval in tok.items():
                if issubclass(type(fval), bool):
                    ...
                    raise ValueError(f"Unsupported value type {ftype!r}")
    ...
    def data_section(self, tokens, labeled=None):
        ...
        for tok, label in tokens:
            for fname, _ftype in self._features:
                s += f"{self._fmt_arff_val(tok.get(fname))},"
            s += f"{self._fmt_arff_val(label)}\n"
