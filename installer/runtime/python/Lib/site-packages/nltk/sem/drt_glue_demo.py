...
class DrtGlueDemo:
    ...
    def _init_exampleListbox(self, parent):
        self._exampleFrame = Frame(parent)
        ...
        for example in self._examples:
            self._exampleList.insert("end", (f"  {example}"))
    ...
    def _init_readingListbox(self, parent):
        self._readingFrame = Frame(parent)
    ...
    def _init_canvas(self, parent):
        ...
        self._canvas = self._cframe.canvas()
        ...
        if example:
            ...
            if cache:
                ...
                try:
                    ...
                    self._exampleList.insert(index, (f"  {example} *"))
