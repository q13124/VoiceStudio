...
class InOrOut:
    ...
    def check_include_omit_etc(self, filename: str, frame: FrameType | None) -> str | None:
        ...
        if self.source_match or self.source_pkgs_match:
            ...
            if not ok and self.source_match and self.source_match.match(filename):
                ok = True
            if not ok:
    ...
    def warn_conflicting_settings(self) -> None:
        ...
        if self.include and (self.source_dirs or self.source_pkgs):
    ...
    def sys_info(self) -> Iterable[tuple[str, Any]]:
        ...
        for matcher_name in matcher_names:
            ...
            matcher_info = matcher.info() if matcher else "-none-"
