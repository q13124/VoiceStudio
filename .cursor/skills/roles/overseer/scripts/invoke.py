#!/usr/bin/env python3
"""Role skill wrapper - invokes context allocator then onboarding CLI for Overseer (Role 0)."""
...
# Navigate from .cursor/skills/roles/overseer/scripts -> project root
PROJECT_ROOT = Path(__file__).resolve().parents[5]
ROLE_ID = "0"
ROLE_PROFILE = "overseer"
