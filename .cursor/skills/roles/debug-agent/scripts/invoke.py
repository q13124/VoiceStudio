#!/usr/bin/env python3
"""Role skill wrapper - invokes context allocator then onboarding CLI for Debug Agent (Role 7)."""
...
# Navigate from .cursor/skills/roles/debug-agent/scripts -> project root
