...
namespace VoiceStudio.App.ViewModels
{
    ...
    public partial class LibraryViewModel : BaseViewModel, IPanelView
    {
        ...
        [ObservableProperty]
        private int selectedAssetCount = 0;

        [ObservableProperty]
        private bool hasMultipleAssetSelection = false;
        ...
        public LibraryViewModel(IBackendClient backendClient)
        {
            ...
            SelectAllAssetsCommand = new RelayCommand(SelectAllAssets, () => Assets != null && Assets.Count > 0);
