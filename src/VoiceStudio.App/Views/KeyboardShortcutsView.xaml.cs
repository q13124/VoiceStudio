    ...
    public sealed partial class KeyboardShortcutsView : UserControl
    {
        ...
        private async void PrintButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                // Show print UI
                var printTaskRequestedHandler = new TypedEventHandler<PrintManager, PrintTaskRequestedEventArgs>((s, args) =>
                {
                    var printTask = args.Request.CreatePrintTask("VoiceStudio Keyboard Shortcuts", (sourceRequested) =>
                    {
