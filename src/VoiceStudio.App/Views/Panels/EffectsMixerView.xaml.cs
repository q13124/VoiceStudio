...
namespace VoiceStudio.App.Views.Panels
{
    public sealed partial class EffectsMixerView : UserControl
    {
        ...
        private void Effect_DragItemsCompleted(UIElement sender, DragItemsCompletedEventArgs e)
        {
            // Clean up drag state
        ...
        private void Effect_DragLeave(object sender, DragEventArgs e)
        {
            if (_dragDropService != null)
            {
                _dragDropService.HideDropTargetIndicator();
        ...
        private void RoutingComboBox_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private async void RoutingComboBox_SelectionChanged(object sender, SelectionChangedEventArgsAlias e)
        {
        ...
        private async void SendEnabled_Unchecked(object sender, RoutedEventArgs e)
        {
            if (sender is CheckBox checkBox && checkBox.DataContext is MixerSend send)
            {
                await ViewModel.UpdateSendCommand.ExecuteAsync(send);
