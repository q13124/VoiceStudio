...
namespace VoiceStudio.App.Views.Panels
{
    ...
    public sealed partial class MarkerManagerView : UserControl
    {
        ...
        private void MarkerManagerView_KeyDown(object sender, KeyRoutedEventArgs e)
        {
            ...
            if (sender is ListView listView && e.OriginalSource is FrameworkElement element)
            {
                ...
                if (marker != null)
                {
                    ...
                    if (_contextMenuService != null)
                    {
                        ...
                        editItem.Click += async (s, e2) => await HandleMarkerMenuClick("Edit", marker);
                        menu.Items.Add(editItem);

                        var duplicateItem = new MenuFlyoutItem { Text = "Duplicate" };
                        duplicateItem.Click += async (s, e2) => await HandleMarkerMenuClick("Duplicate", marker);
                        menu.Items.Add(duplicateItem);

                        menu.Items.Add(new MenuFlyoutSeparator());

                        var deleteItem = new MenuFlyoutItem { Text = "Delete" };
                        deleteItem.Click += async (s, e2) => await HandleMarkerMenuClick("Delete", marker);
        ...
        private void MarkerManagerView_KeyboardNavigation_Loaded(object sender, RoutedEventArgs e)
        {
