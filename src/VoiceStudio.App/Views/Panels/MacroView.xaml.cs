...
namespace VoiceStudio.App.Views.Panels
{
    public sealed partial class MacroView : UserControl
    {
        ...
        private async System.Threading.Tasks.Task DuplicateMacroAsync(Macro macro)
        {
            try
            {
        ...
        private async System.Threading.Tasks.Task DuplicateAutomationCurveAsync(AutomationCurve curve)
        {
            try
            {
