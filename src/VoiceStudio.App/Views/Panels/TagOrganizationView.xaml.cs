...
namespace VoiceStudio.App.Views.Panels
{
    ...
    public sealed partial class TagOrganizationView : UserControl
    {
        ...
        private void TagOrganizationView_Loaded(object sender, RoutedEventArgs e)
        {
            _ = ViewModel.RefreshCommand.ExecuteAsync(null);
        }
        
        private void TagOrganizationView_KeyboardNavigation_Loaded(object sender, RoutedEventArgs e)
        {
