    ...
    public sealed partial class TextSpeechEditorView : UserControl
    {
        ...
        private void TextSpeechEditorView_KeyDown(object sender, KeyRoutedEventArgs e)
        {
            ...
            if (e.Key == VirtualKey.S)
            {
                ...
                {
                    if (ViewModel.UpdateSessionCommand.CanExecute(null))
                    {
            ...
            else if (e.Key == VirtualKey.N)
            {
                if (InputHelper.IsControlPressed())
                {
                    if (ViewModel.CreateSessionCommand.CanExecute(null))
                    {
            ...
            if (sender is ListView listView && e.OriginalSource is FrameworkElement element)
            {
                ...
                if (session != null)
                {
                    ...
                    if (_contextMenuService != null)
                    {
                        ...
                        exportItem.Click += async (s, e2) => await HandleSessionMenuClick("Export", session);
        ...
        private void TextSpeechEditorView_KeyboardNavigation_Loaded(object sender, RoutedEventArgs e)
        {
