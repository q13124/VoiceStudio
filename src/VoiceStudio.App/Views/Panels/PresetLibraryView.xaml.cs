...
namespace VoiceStudio.App.Views.Panels
{
    ...
    public sealed partial class PresetLibraryView : UserControl
    {
        ...
        private void PresetLibraryView_KeyboardNavigation_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (sender is ListView listView && e.OriginalSource is FrameworkElement element)
            {
                ...
                if (preset != null)
                {
                    ...
                    if (_contextMenuService != null)
                    {
                        ...
                        applyItem.Click += async (s, e2) => await HandlePresetMenuClick("Apply", preset);
                        menu.Items.Add(applyItem);

                        var editItem = new MenuFlyoutItem { Text = "Edit" };
                        editItem.Click += async (s, e2) => await HandlePresetMenuClick("Edit", preset);
                        ...
                        exportItem.Click += async (s, e2) => await HandlePresetMenuClick("Export", preset);
