...
namespace VoiceStudio.App.Views.Panels
{
  public sealed partial class PluginManagementView : UserControl
  {
    ...
    private void PluginManagementView_KeyboardNavigation_Loaded(object _, Microsoft.UI.Xaml.RoutedEventArgs __)
    {
      KeyboardNavigationHelper.SetupTabNavigation(this);
    }

    private void PluginManagementView_KeyDown(object _, KeyRoutedEventArgs e)
    {
      ...
      {
        if (ViewModel.SelectedPlugin?.IsEnabled == true && ViewModel.DisablePluginCommand.CanExecute(ViewModel.SelectedPlugin))
        {
