...
namespace VoiceStudio.App.Views.Panels
{
    public partial class VoiceSynthesisViewModel : ObservableObject, IPanelView, IDisposable
    {
        ...
        [ObservableProperty]
        private bool hasQualityMetrics = false;
        ...
        [ObservableProperty]
        private bool hasQualityRecommendation = false;

        [ObservableProperty]
        private bool isAnalyzingText = false;

        [ObservableProperty]
        private bool autoApplyRecommendations = false;
        ...
        [ObservableProperty]
        private bool hasRealTimeQualityFeedback = false;

        // Multi-Engine Ensemble (IDEA 55)
        [ObservableProperty]
        private bool useMultiEngineEnsemble = false;
        ...
        [ObservableProperty]
        private bool hasEnsembleStatus = false;

        [ObservableProperty]
        private bool isEnsembleProcessing = false;
        ...
        [ObservableProperty]
        private bool isPreviewingPipeline = false;
        ...
        [ObservableProperty]
        private bool hasPipelineComparison = false;
        ...
        public VoiceSynthesisViewModel(IBackendClient backendClient, IAudioPlayerService audioPlayer)
        {
            ...
            _isPlayingChangedHandler = (s, e) => PlayAudioCommand.NotifyCanExecuteChanged();
            _playbackCompletedHandler = (s, e) => PlayAudioCommand.NotifyCanExecuteChanged();
        ...
        private async Task SynthesizeAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    var feedback = _qualityService.StartTracking(
                        _currentSynthesisId,
                        SelectedProfile.Id,
                        SelectedEngine
                    );
                ...
                if (_qualityService != null && _currentSynthesisId != null)
                {
                    var completedFeedback = _qualityService.CompleteTracking(
                        _currentSynthesisId,
                        response.QualityMetrics,
                        response.QualityScore
                    );
                    RealTimeQualityFeedback = completedFeedback;
                    OnPropertyChanged(nameof(RealTimeQualityFeedback));
                }
