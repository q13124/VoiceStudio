...
namespace VoiceStudio.App.Views.Panels
{
    ...
    public sealed partial class ImageVideoEnhancementPipelineView : UserControl
    {
        ...
        private void ImageVideoEnhancementPipelineView_KeyboardNavigation_Loaded(object sender, RoutedEventArgs e)
        {
            KeyboardNavigationHelper.SetupTabNavigation(this);
        }

        private void EnhancementItem_PointerPressed(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
