...
namespace VoiceStudio.App.Views.Panels
{
    ...
    public sealed partial class DeepfakeCreatorView : UserControl
    {
        ...
        private async void BrowseSourceFaceButton_Click(object sender, RoutedEventArgs e)
        {
        ...
        private async void BrowseTargetMediaButton_Click(object sender, RoutedEventArgs e)
        {
            var picker = new FileOpenPicker();
