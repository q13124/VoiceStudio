...
namespace VoiceStudio.App.Views.Dialogs
{
    public sealed partial class ToolbarCustomizationDialog : ContentDialog
    {
        ...
        private async void PresetComboBox_SelectionChanged(object sender, Microsoft.UI.Xaml.Controls.SelectionChangedEventArgs e)
        {
        ...
        private async void SavePresetButton_Click(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
