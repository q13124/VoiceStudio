...
namespace VoiceStudio.App.Controls
{
  ...
  public sealed partial class BatchQueueTimelineControl : UserControl
  {
    ...
    private double EstimateJobDuration(BatchJob job)
    {
      ...
      const double baseTimePerChar = ESTIMATED_SECONDS_PER_CHARACTER;
    ...
    private void DrawTimeMarkers(double _)
    {
      const double markerInterval = 1.0; // 1 second intervals
    ...
    private void DrawJobBlocks()
    {
      ...
      const double yOffset = 25.0; // Space for time markers
    ...
    private void ZoomIn_Click(object _, RoutedEventArgs __)
    {
      ZoomLevel *= 1.5;
    }

    private void ZoomOut_Click(object _, RoutedEventArgs __)
    {
      ZoomLevel /= 1.5;
    }

    private void Fit_Click(object _, RoutedEventArgs __)
    {
    ...
    private void TimelineCanvas_PointerMoved(object _, PointerRoutedEventArgs __)
    {
      // Could implement panning here
    }

    private void TimelineCanvas_PointerReleased(object _, PointerRoutedEventArgs __)
    {
