...
namespace VoiceStudio.App.Controls
{
    ...
    public sealed partial class PhaseAnalysisControl : UserControl
    {
        ...
        private void PhaseAnalysisControl_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            UpdatePhase();
        ...
        private void UpdatePhase()
        {
            ...
            if (_stereoWidthPath != null && Data.StereoWidth != null && Data.StereoWidth.Count > 0)
            {
                var pathGeometry = new PathGeometry();
                var pathFigure = new PathFigure();
