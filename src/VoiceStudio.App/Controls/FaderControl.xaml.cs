...
namespace VoiceStudio.App.Controls
{
  ...
  public sealed partial class FaderControl : UserControl
  {
    ...
    private void UpdateFaderPosition()
    {
      ...
      if (!(FaderBackground.Parent is FrameworkElement faderTrack))
        return;
    ...
    private void FaderKnob_PointerPressed(object _, PointerRoutedEventArgs e)
    {
    ...
    private void FaderKnob_PointerMoved(object _, PointerRoutedEventArgs e)
    {
    ...
    private void FaderKnob_PointerReleased(object _, PointerRoutedEventArgs e)
    {
    ...
    private void FaderControl_SizeChanged(object _, Microsoft.UI.Xaml.SizeChangedEventArgs __)
    {
      // Update fader position when control size changes
      UpdateFaderPosition();
    }

    private void FaderControl_Loaded(object _, Microsoft.UI.Xaml.RoutedEventArgs __)
    {
