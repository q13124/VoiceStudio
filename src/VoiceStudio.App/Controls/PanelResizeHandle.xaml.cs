...
namespace VoiceStudio.App.Controls
{
    ...
    public sealed partial class PanelResizeHandle : UserControl
    {
        ...
        private void PanelResizeHandle_PointerPressed(object sender, PointerRoutedEventArgs e)
        {
        ...
        private void PanelResizeHandle_PointerMoved(object sender, PointerRoutedEventArgs e)
        {
        ...
        private void PanelResizeHandle_PointerReleased(object sender, PointerRoutedEventArgs e)
        {
            EndResize();
            e.Handled = true;
        }

        private void PanelResizeHandle_PointerCanceled(object sender, PointerRoutedEventArgs e)
        {
            EndResize();
            e.Handled = true;
        }
    ...
    public enum ResizeDirection
    {
        ...
        Both         // Resize both width and height
    }
}
