...
namespace VoiceStudio.App.Controls
{
  ...
  public sealed partial class PanFaderControl : UserControl
  {
    ...
    private void UpdateKnobPosition()
    {
      ...
      PanFaderKnobTransform.X = (double)(pan * maxOffset);
    }

    private void PanFaderKnob_PointerPressed(object _, PointerRoutedEventArgs e)
    {
    ...
    private void PanFaderKnob_PointerMoved(object _, PointerRoutedEventArgs e)
    {
      if (!_isDragging)
        return;
    ...
    private void PanFaderKnob_PointerReleased(object _, PointerRoutedEventArgs e)
    {
      if (_isDragging)
      {
        _isDragging = false;
    ...
    private void PanFaderControl_SizeChanged(object _, Microsoft.UI.Xaml.SizeChangedEventArgs e)
    {
      UpdateKnobPosition();
    }
  }
