  ...
  public static class ServiceProvider
  {
    ...
    public static void Initialize()
    {
      ...
      try
      {
        ...
        // Initialize EngineManager (manages both remote and local engine instances)
        InitializeService(
            () => new EngineManager(_backendClient),
            service => _engineManager = service,
            "EngineManager");
        ...
        InitializeService(
            () => new PanelStateService(_settingsService ?? throw new InvalidOperationException("SettingsService not initialized")),
    ...
    public static EngineManager GetEngineManager()
    {
      ...
      return _engineManager ?? throw new InvalidOperationException("EngineManager not initialized");
    }
