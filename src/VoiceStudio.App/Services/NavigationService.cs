    ...
    public class NavigationService : INavigationService
    {
        ...
        private void LoadNavigationState()
        {
            try
            {
                ...
                if (localSettings.Values.TryGetValue(NavigationStateKey, out var value) && value is ApplicationDataCompositeValue composite)
                {
                    if (composite.TryGetValue("CurrentPanelId", out var panelId) && panelId is string panelIdStr)
                    {
