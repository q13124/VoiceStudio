...
namespace VoiceStudio.Core.Models
{
    ...
    public class MixerChannel
    {
        ...
        public double PeakLevel { get; set; } = 0.0;
        public double RmsLevel { get; set; } = 0.0;
        public double Volume { get; set; } = 1.0; // 0.0 to 2.0 (0 = -∞ dB, 1.0 = 0 dB, 2.0 = +6 dB)
        public double Pan { get; set; } = 0.0; // -1.0 (left) to 1.0 (right), 0.0 = center
    ...
    public class MixerReturn
    {
        ...
        public double Pan { get; set; } = 0.0; // Return bus pan (-1.0 to 1.0)
        public bool IsEnabled { get; set; } = true;
    ...
    public class MixerSubGroup
    {
        ...
        public double Pan { get; set; } = 0.0; // Sub-group pan (-1.0 to 1.0)
        public bool IsMuted { get; set; } = false;
        public bool IsSoloed { get; set; } = false;
    ...
    public class MixerMaster
    {
        ...
        public double Pan { get; set; } = 0.0; // Master pan (-1.0 to 1.0)
        public bool IsMuted { get; set; } = false;
        public double PeakLevel { get; set; } = 0.0;
        public double RmsLevel { get; set; } = 0.0;
    ...
    {
        Master,      // Route directly to master bus
        SubGroup     // Route to a sub-group bus
    }
