"""Piper adapter wrapping the existing Piper engine implementation."""
...
class PiperEngineAdapter:
    """Adapter wrapping the Piper engine for plugin-based synthesis."""

    #: Native output sample rate for Piper.
    SAMPLE_RATE: int = 22050

    def __init__(self, engine_cls=None) -> None:
        if engine_cls is None:
            module = importlib.import_module("app.core.engines.piper_engine")
            engine_cls = module.PiperEngine
