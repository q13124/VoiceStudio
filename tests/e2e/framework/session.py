...
class SessionManager:
    ...
    def __init__(self, config: SessionConfig | None = None):
        ...
        self._winappdriver_process: subprocess.Popen | None = None
        self._app_process: psutil.Process | None = None
    ...
    def create_session(self, config: SessionConfig | None = None) -> Any:
        """
        ...
        try:
            ...
            # Fallback for selenium without appium-python-client
            ...
            self._driver.implicitly_wait(config.implicit_wait)
            logger.info("Session created successfully (selenium mode)")
    ...
    @contextmanager
    def session(self, config: SessionConfig | None = None):
        """
...
class MockSessionManager(SessionManager):
    ...
    def create_session(self, config: SessionConfig | None = None) -> MockDriver:
        """Create mock session."""
