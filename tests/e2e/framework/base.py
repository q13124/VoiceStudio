...
class E2ETestBase:
    ...
    def wait_for_backend(self, timeout: Optional[float] = None) -> bool:
    ...
    def capture_screenshot(self, name: str) -> Optional[Path]:
    ...
    def capture_failure_screenshot(self, test_name: str) -> Optional[Path]:
