...
class TestWizardFlowMock:
    ...
    def test_page_objects_importable(self):
        ...
        from tests.e2e.pages import VoiceQuickClonePage
        from tests.e2e.pages import VoiceBrowserPage
        from tests.e2e.pages import SynthesisPage
    ...
    def test_mock_wizard_flow(
        self,
        sample_audio_file: str,
        unique_profile_name: str
    ):
        """
...
class TestVoiceCloningWizard(E2ETestBase):
    ...
    def test_complete_voice_cloning_workflow(
        ...
        """
        from tests.e2e.pages import MainWindowPage, VoiceQuickClonePage
    ...
    def test_wizard_error_handling(
        self,
        tmp_path: Path,
        unique_profile_name: str,
        app_session
...
class TestWizardBackendIntegration:
    ...
    def test_profile_listing_after_clone(
        self,
        api_client
    ):
        """
...
class TestWizardPerformance:
    ...
    def test_wizard_navigation_performance(
        self,
        app_session,
        performance_timer
    ):
