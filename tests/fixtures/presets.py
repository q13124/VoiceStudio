...
SYNTHESIS_PRESETS: list[SynthesisPreset] = [
    ...
    SynthesisPreset(
        ...
        "More consistent, precise output",
        "neural",
    ),
    SynthesisPreset(
        "synth_xtts_streaming",
        "XTTS Streaming",
        "xtts",
        "default",
        "en",
    ...
    SynthesisPreset(
        ...
        "Default Bark synthesis",
        "neural",
    ),
    SynthesisPreset(
        "synth_bark_expressive",
        "Bark Expressive",
        "bark",
        "v2/en_speaker_6",
        "en",
    ...
    SynthesisPreset(
        ...
        "Default OpenVoice settings",
        "neural",
    ),
    # Chatterbox presets
    SynthesisPreset(
        "synth_chatterbox_default",
        "Chatterbox Default",
        "chatterbox",
        "default",
        "en",
        {"exaggeration": 0.5, "cfg_weight": 0.5},
        "Default Chatterbox conversational",
        "neural",
    ),
    SynthesisPreset(
        "synth_chatterbox_expressive",
        "Chatterbox Expressive",
        "chatterbox",
        "default",
        "en",
        {"exaggeration": 0.8, "cfg_weight": 0.3},
        "More expressive conversational",
        "neural",
    ),
    # Use case presets
    SynthesisPreset(
...
EFFECT_CHAIN_PRESETS: list[EffectChainPreset] = [
    # Bypass
    EffectChainPreset("fx_bypass", "Bypass", "utility", [], "No effects (passthrough)"),
    # Basic processing
    EffectChainPreset(
        "fx_normalize",
        "Normalize Only",
    ...
    EffectChainPreset(
        ...
        [
            {
                "type": "compressor",
                "params": {"threshold": -20, "ratio": 4, "attack": 10, "release": 100},
            },
    ...
    EffectChainPreset(
        ...
        [
            ...
            {
                "type": "compressor",
                "params": {"threshold": -18, "ratio": 3.5, "attack": 15, "release": 150},
            },
    ...
    EffectChainPreset(
        ...
        [
            ...
            {
                "type": "equalizer",
                "params": {"low_shelf_freq": 200, "low_shelf_gain": -2, "presence_gain": 4},
            },
            {
                "type": "compressor",
                "params": {"threshold": -15, "ratio": 5, "attack": 5, "release": 100},
            },
    ...
    EffectChainPreset(
        ...
        [
            ...
            {
                "type": "compressor",
                "params": {"threshold": -18, "ratio": 2, "attack": 30, "release": 250},
            },
...
TRAINING_PRESETS: list[TrainingPreset] = [
    ...
    TrainingPreset(
        ...
        "High quality training with early stopping",
        "quality",
        180,
    ),
    ...
    TrainingPreset(
        ...
        "Quick SoVITS training",
        "quick",
        20,
    ),
    TrainingPreset(
        "train_sovits_standard",
        "SoVITS Standard",
        "so-vits-svc",
        {
            "epochs": 500,
...
PROJECT_TEMPLATES: list[ProjectTemplate] = [
    ...
    ProjectTemplate(
        "template_music",
        "Music with Vocals",
        "Song production with synthesized vocals",
        "creative",
