...
VS_APP_PATH = os.getenv("VS_APP_PATH", r"E:\VoiceStudio\src\VoiceStudio.App\.buildlogs\x64\Debug\net8.0-windows10.0.19041.0\VoiceStudio.App.exe")
...
def main():
    ...
    try:
        ...
        for elem in by_name[:5]:
            try:
                print(f"  - AutomationId: {elem.get_attribute('AutomationId')}, Class: {elem.get_attribute('ClassName')}")
            except:
                pass
    except Exception as e:
