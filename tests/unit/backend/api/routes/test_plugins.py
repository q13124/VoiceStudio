...
class TestPluginsEndpoints:
    ...
    def test_install_plugin(self, plugins_client):
        ...
        response = plugins_client.post("/api/plugins/install", json={"plugin_id": "test-plugin"})
    ...
    def test_uninstall_plugin(self, plugins_client):
        ...
        response = plugins_client.post("/api/plugins/uninstall", json={"plugin_id": "test-plugin"})
