...
try:
    ...
    pytest.skip("Could not import image_search route module", allow_module_level=True)
...
class TestImageSearchRouteImports:
    ...
    def test_image_search_module_imports(self):
        ...
        assert image_search is not None, "Failed to import image_search module"
        assert hasattr(image_search, "router"), "image_search module missing router"
...
class TestImageSearchRouteHandlers:
    ...
    def test_search_images_handler_exists(self):
        ...
        if hasattr(image_search, "search_images"):
            assert callable(image_search.search_images), "search_images is not callable"
