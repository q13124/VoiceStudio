...
- VS-0003: Installer package verification and upgrade/rollback path (Gate H, Release Engineer) - IN_PROGRESS
...
- VS-0012: App crash on startup: 0xE0434352 / 0x80040154 (WinUI class not registered) (Gate C, Release Engineer) - TRIAGE
