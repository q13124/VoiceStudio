...
class ProcessWatchdog:
    ...
    def __init__(self, config: WatchdogConfig | None = None):
        ...
        # Callbacks
        self._on_state_change: Callable[[ProcessState, ProcessState], None] | None = None
        self._on_restart: Callable[[RestartRecord], None] | None = None
        self._on_health_check_failure: Callable[[int], None] | None = None
    ...
    def set_callbacks(
        self,
        on_state_change: Callable[[ProcessState, ProcessState], None] | None = None,
        on_restart: Callable[[RestartRecord], None] | None = None,
        on_health_check_failure: Callable[[int], None] | None = None,
    ) -> None:
    ...
    def _record_restart(self, reason: str, exit_code: int | None = None) -> RestartRecord:
...
async def run_watchdog(config: WatchdogConfig | None = None) -> None:
