...
class TranslationEngine:
    ...
    async def _load_seamless_model(self) -> Optional[Dict[str, Any]]:
    ...
    async def _load_whisper_model(self) -> Optional[Dict[str, Any]]:
    ...
    async def _load_local_model(self) -> Optional[Dict[str, Any]]:
