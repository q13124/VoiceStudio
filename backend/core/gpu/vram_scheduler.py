...
class ScheduledRequest:
    ...
    _allocation: Optional[MemoryAllocation] = field(compare=False, default=None)
    _result: Any = field(compare=False, default=None)
    _error: Optional[Exception] = field(compare=False, default=None)
...
class VRAMScheduler:
    ...
    def __init__(
        self,
        memory_pool: Optional[GPUMemoryPool] = None,
...
_vram_scheduler: Optional[VRAMScheduler] = None
