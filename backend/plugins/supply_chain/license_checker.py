...
COMPATIBILITY_MATRIX: Dict[Tuple[LicenseCategory, LicenseCategory], CompatibilityLevel] = {
    ...
    (LicenseCategory.PERMISSIVE, LicenseCategory.COPYLEFT_WEAK): CompatibilityLevel.COMPATIBLE_WITH_NOTICE,
    ...
    (LicenseCategory.COPYLEFT_WEAK, LicenseCategory.COPYLEFT_WEAK): CompatibilityLevel.COMPATIBLE_WITH_NOTICE,
    (LicenseCategory.COPYLEFT_WEAK, LicenseCategory.COPYLEFT_STRONG): CompatibilityLevel.REQUIRES_REVIEW,
    (LicenseCategory.COPYLEFT_WEAK, LicenseCategory.PROPRIETARY): CompatibilityLevel.REQUIRES_REVIEW,
    ...
    (LicenseCategory.COPYLEFT_STRONG, LicenseCategory.COPYLEFT_STRONG): CompatibilityLevel.COMPATIBLE,
    ...
    (LicenseCategory.PUBLIC_DOMAIN, LicenseCategory.COPYLEFT_WEAK): CompatibilityLevel.COMPATIBLE_WITH_NOTICE,
    (LicenseCategory.PUBLIC_DOMAIN, LicenseCategory.COPYLEFT_STRONG): CompatibilityLevel.INCOMPATIBLE,
    (LicenseCategory.PUBLIC_DOMAIN, LicenseCategory.PROPRIETARY): CompatibilityLevel.REQUIRES_REVIEW,
    
    # Proprietary is restrictive
    (LicenseCategory.PROPRIETARY, LicenseCategory.PERMISSIVE): CompatibilityLevel.COMPATIBLE_WITH_NOTICE,
    (LicenseCategory.PROPRIETARY, LicenseCategory.PUBLIC_DOMAIN): CompatibilityLevel.COMPATIBLE,
    (LicenseCategory.PROPRIETARY, LicenseCategory.COPYLEFT_WEAK): CompatibilityLevel.REQUIRES_REVIEW,
...
class LicenseCheckResult:
    ...
    def has_incompatible(self) -> bool:
        ...
        return any(
            i.level == CompatibilityLevel.INCOMPATIBLE
    ...
    def has_copyleft(self) -> bool:
        ...
        return any(
            d.license_info and d.license_info.copyleft
    ...
    def requires_review(self) -> bool:
        ...
        return any(
            i.level == CompatibilityLevel.REQUIRES_REVIEW
            for i in self.issues
        )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "plugin_license_info": self.plugin_license_info.to_dict() if self.plugin_license_info else None,
...
def check_license_compatibility(
    ...
    checker = LicenseChecker()
    return {
        lic: checker.check_compatibility(project_license, lic)
        for lic in dependency_licenses
    }
