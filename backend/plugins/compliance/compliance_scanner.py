    ...
    def _identify_license(self, content: str) -> Optional[str]:
        ...
        if "mit license" in content_lower or "permission is hereby granted, free of charge" in content_lower:
            ...
            if "version 3" in content_lower:
                ...
                return "GPL-2.0"
        elif "bsd 3-clause" in content_lower or "redistribution and use in source and binary forms" in content_lower:
            return "BSD-3-Clause"
        ...
        try:
            ...
            if stdout:
                ...
                for result in data.get("results", []):
                    severity = (
                        IssueSeverity.BLOCKER if result.get("issue_severity") == "HIGH"
                        else IssueSeverity.MAJOR if result.get("issue_severity") == "MEDIUM"
