...
class TelemetryService:
    ...
    def track_feature_use(self, feature_name: str, details: Optional[dict[str, Any]] = None) -> None:
        """Track feature usage."""
        self.track_event(
    ...
    def track_crash(self, exception: Exception, context: Optional[dict[str, Any]] = None) -> None:
