...
class ApiVersionNegotiator:
    ...
    def __init__(self, default_version: Optional[ApiVersion] = None):
        """
    ...
    def _from_url(self, path: str) -> Optional[ApiVersion]:
    ...
    def _from_accept(self, accept: str) -> Optional[ApiVersion]:
...
class VersionNegotiationMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app, negotiator: Optional[ApiVersionNegotiator] = None):
        super().__init__(app)
