    ...
    def synthesize(
        ...
        **kwargs
        ...
        try:
            ...
            if 'return_audio' in kwargs and kwargs['return_audio']:
                try:
...
# Global instances
_gtts_instance: Optional[GTTSWrapper] = None
_pyttsx3_instance: Optional[Pyttsx3Wrapper] = None


def get_gtts() -> Optional[GTTSWrapper]:
...
def get_pyttsx3() -> Optional[Pyttsx3Wrapper]:
