...
class ContextEnricher:
    ...
    def __init__(
        self,
        subsystem_registry_path: Optional[Path] = None,
    ...
    def _map_file_to_subsystem(self, file_path: Optional[str]) -> Optional[str]:
        ...
        for pattern in self._subsystem_map:
            ...
            if "/" in glob_pattern:
                if normalized.endswith(glob_pattern.lstrip("*/")):
                    return subsystem
    ...
    def _extract_role(self, owner: str) -> Optional[str]:
    ...
    def _get_task_info(self, task_id: Optional[str]) -> Dict[str, Any]:
    ...
    def _resolve_role(self, task_id: Optional[str]) -> Optional[str]:
    ...
    def get_role_for_task(self, task_id: str) -> Optional[str]:
        """
