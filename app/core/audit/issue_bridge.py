...
class AuditIssueBridge:
    ...
    def on_audit_entry(self, entry: AuditEntry) -> str | None:
        """
    ...
    def _create_issue(self, entry: AuditEntry, pattern_hash: str) -> str | None:
        """
    ...
    def _map_severity(self, severity_str: str | None):
    ...
    def get_issue_for_entry(self, entry_id: str) -> str | None:
...
_audit_issue_bridge: AuditIssueBridge | None = None
