...
from .engine_lifecycle import EngineState, get_lifecycle_manager
...
class EnhancedRuntimeEngine:
    ...
    def __init__(
        ...
        self.stderr_file: Path | None = None

        # Open file handles for process output (to be closed on stop)
        self._stdout_handle: IO | None = None
        self._stderr_handle: IO | None = None
    ...
    def start(self, job_id: str | None = None) -> bool:
        """
    ...
    def stop(self, job_id: str | None = None):
...
class EnhancedRuntimeEngineManager:
    ...
    def start_engine(self, engine_id: str, job_id: str | None = None) -> bool:
    ...
    def stop_engine(self, engine_id: str, job_id: str | None = None):
        """Stop an engine by ID."""
        if engine_id in self.engines:
            self.engines[engine_id].stop(job_id=job_id)

    def get_engine(self, engine_id: str) -> EnhancedRuntimeEngine | None:
        """Get engine by ID."""
