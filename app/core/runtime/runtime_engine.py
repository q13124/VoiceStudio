...
class RuntimeEngineManager:
    ...
    def load_engine(self, manifest_path: str) -> Optional[RuntimeEngine]:
        """
    ...
    def get_engine(self, engine_id: str) -> Optional[RuntimeEngine]:
        """Get engine by ID."""
        return self.engines.get(engine_id)
    
    def get_engine_for_task(self, task: str, prefer_default: bool = True) -> Optional[RuntimeEngine]:
        """
