...
class EngineHook:
    ...
    def get_engine(self, engine_name: str, **kwargs) -> Optional[Union[EngineProtocol, RuntimeEngine]]:
        """
    ...
    def get_engine_for_task(self, task: str) -> Optional[Union[EngineProtocol, RuntimeEngine]]:
        """
    ...
    def get_default_engine(self, task_type: str) -> Optional[Union[EngineProtocol, RuntimeEngine]]:
        """
